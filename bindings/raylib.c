...
static int l_GetDroppedFiles(lua_State *L) {
  int count;
...
static int l_SetConfigFlags(lua_State *L) {
  unsigned char flags = luaL_checkinteger(L, 1);
  SetConfigFlags(flags);
  return 0;
}

// Enable/Disable VR experience
static int l_ToggleVrMode(lua_State *L) {
...
static int l_CloseVrSimulator(lua_State *L) {
  (void)L; // Suppress unused warning
  CloseVrSimulator();
  return 0;
}
...
static int l_ImageColorTintU(lua_State *L) {
  Image* image = (Image*)luaL_checkudata(L, 1, "Image");
...
static int l_ImageRotateCCW(lua_State *L) {
  Image* image = (Image*)luaL_checkudata(L, 1, "Image");
...
static int l_DrawCubeWiresU(lua_State *L) {
...
static int l_SetTraceLogExit(lua_State *L) {
...
static int l_LoadFontEx(lua_State *L) {
  const char* fileName = luaL_checkstring(L, 1);
  int fontSize = luaL_checkinteger(L, 2);
  int* fontChars = (int*)luaL_checkudata(L, 3, "int");
  int charsCount = luaL_checkinteger(L, 4);
  Font result = LoadFontEx(fileName, fontSize, fontChars, charsCount);
...
static int l_GetNextCodepoint(lua_State *L) {
  const char* text = luaL_checkstring(L, 1);
  int* count = (int*)luaL_checkudata(L, 2, "int");
...
static int l_CheckCollisionCirclesU(lua_State *L) {
...
static int l_TextIsEqual(lua_State *L) {
...
static int l_DrawModelEx(lua_State *L) {
...
static int l_DrawModelExU(lua_State *L) {
  Model model = (*(Model*)luaL_checkudata(L, 1, "Model"));
...
static int l_DrawTextureProU(lua_State *L) {
...
// Stop audio stream
static int l_StopAudioStream(lua_State *L) {
...
static int l_ImageText(lua_State *L) {
  const char* text = luaL_checkstring(L, 1);
  int fontSize = luaL_checkinteger(L, 2);
...
static int l_ImageTextU(lua_State *L) {
  const char* text = luaL_checkstring(L, 1);
  int fontSize = luaL_checkinteger(L, 2);
...
static int l_DrawRectangleRecU(lua_State *L) {
...
static int l_SetVrConfiguration(lua_State *L) {
...
static int l_CloseAudioStream(lua_State *L) {
  AudioStream stream = (*(AudioStream*)luaL_checkudata(L, 1, "AudioStream"));
...
static int l_StorageSaveValue(lua_State *L) {
...
static int l_IsAudioStreamPlaying(lua_State *L) {
  AudioStream stream = (*(AudioStream*)luaL_checkudata(L, 1, "AudioStream"));
...
static int l_GenTextureBRDF(lua_State *L) {
...
static int l_GenTextureBRDFU(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
  int size = luaL_checkinteger(L, 2);
  Texture2D result = GenTextureBRDF(shader, size);
  Texture2D* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = result; luaL_setmetatable(L, "Texture2D");
...
static int l_CheckCollisionRayBox(lua_State *L) {
...
static int l_GenImageWhiteNoise(lua_State *L) {
...
static int l_GetGestureDetected(lua_State *L) {
...
static int l_IsAudioBufferProcessed(lua_State *L) {
  AudioStream stream = (*(AudioStream*)luaL_checkudata(L, 1, "AudioStream"));
...
static int l_ColorToHSV(lua_State *L) {
...
static int l_ColorToHSVU(lua_State *L) {
...
static int l_GetImageDataNormalized(lua_State *L) {
  Image image = (*(Image*)luaL_checkudata(L, 1, "Image"));
...
static int l_GetGamepadAxisCount(lua_State *L) {
...
static int l_DrawCircleU(lua_State *L) {
  int centerX = luaL_checkinteger(L, 1);
  int centerY = luaL_checkinteger(L, 2);
  float radius = luaL_checknumber(L, 3);
...
static int l_LoadFontData(lua_State *L) {
  const char* fileName = luaL_checkstring(L, 1);
  int fontSize = luaL_checkinteger(L, 2);
  int* fontChars = (int*)luaL_checkudata(L, 3, "int");
  int charsCount = luaL_checkinteger(L, 4);
  int type = luaL_checkinteger(L, 5);
  CharInfo* result = LoadFontData(fileName, fontSize, fontChars, charsCount, type);
  if (result == NULL) lua_pushnil(L); else { CharInfo* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = *result; luaL_setmetatable(L, "CharInfo");}
  return 1;
}
...
static int l_ExportWave(lua_State *L) {
...
static int l_ColorToInt(lua_State *L) {
  Color color = (*(Color*)luaL_checkudata(L, 1, "Color"));
...
static int l_ColorToIntU(lua_State *L) {
  Color color = {luaL_checkinteger(L, 1),luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4)};
  int result = ColorToInt(color);
  lua_pushinteger(L, result);
  return 1;
...
static int l_DrawCubeWiresV(lua_State *L) {
  Vector3 position = (*(Vector3*)luaL_checkudata(L, 1, "Vector3"));
...
static int l_DrawCubeWiresVU(lua_State *L) {
  Vector3 position = {luaL_checknumber(L, 1),luaL_checknumber(L, 2),luaL_checknumber(L, 3)};
...
static int l_CheckCollisionBoxes(lua_State *L) {
...
static int l_ImageTextEx(lua_State *L) {
...
static int l_ImageTextExU(lua_State *L) {
  Font font = (*(Font*)luaL_checkudata(L, 1, "Font"));
  const char* text = luaL_checkstring(L, 2);
  float fontSize = luaL_checknumber(L, 3);
  float spacing = luaL_checknumber(L, 4);
...
static int l_DrawCircleSectorLinesU(lua_State *L) {
...
static int l_SetCameraMode(lua_State *L) {
  Camera3D camera = (*(Camera3D*)luaL_checkudata(L, 1, "Camera3D"));
...
static int l_GetGestureDragVector(lua_State *L) {
...
static int l_GetGestureDragVectorU(lua_State *L) {
  Vector2 result = GetGestureDragVector();
  Vector2* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = result; luaL_setmetatable(L, "Vector2");
...
static int l_GenTextureIrradiance(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
...
static int l_GenTextureIrradianceU(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
...
static int l_GetCameraMatrix(lua_State *L) {
  Camera3D camera = (*(Camera3D*)luaL_checkudata(L, 1, "Camera3D"));
...
static int l_GetCameraMatrixU(lua_State *L) {
  Camera3D camera = (*(Camera3D*)luaL_checkudata(L, 1, "Camera3D"));
  Matrix result = GetCameraMatrix(camera);
  Matrix* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = result; luaL_setmetatable(L, "Matrix");
...
static int l_DrawLineExU(lua_State *L) {
...
static int l_UnloadMaterial(lua_State *L) {
...
static int l_ImageRotateCW(lua_State *L) {
  Image* image = (Image*)luaL_checkudata(L, 1, "Image");
  ImageRotateCW(image);
  return 0;
}
...
static int l_ExportImageAsCode(lua_State *L) {
  Image image = (*(Image*)luaL_checkudata(L, 1, "Image"));
  const char* fileName = luaL_checkstring(L, 2);
...
static int l_GetCollisionRayGround(lua_State *L) {
  Ray ray = (*(Ray*)luaL_checkudata(L, 1, "Ray"));
...
static int l_GenMeshHemiSphere(lua_State *L) {
...
static int l_InitAudioStream(lua_State *L) {
...
static int l_GetScreenData(lua_State *L) {
...
static int l_GenImageGradientRadial(lua_State *L) {
  int width = luaL_checkinteger(L, 1);
  int height = luaL_checkinteger(L, 2);
...
static int l_GenImageGradientRadialU(lua_State *L) {
  int width = luaL_checkinteger(L, 1);
  int height = luaL_checkinteger(L, 2);
  float density = luaL_checknumber(L, 3);
...
static int l_GetFontDefault(lua_State *L) {
...
static int l_FadeU(lua_State *L) {
  Color color = {luaL_checkinteger(L, 1),luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4)};
...
static int l_SetMatrixProjection(lua_State *L) {
...
static int l_SetMatrixProjectionU(lua_State *L) {
...
static int l_DrawCircle3DU(lua_State *L) {
...
static int l_TextToLower(lua_State *L) {
  const char* text = luaL_checkstring(L, 1);
...
static int l_SetTraceLogCallback(lua_State *L) {
...
static int l_CheckCollisionRecsU(lua_State *L) {
...
static int l_MeshBoundingBox(lua_State *L) {
...
static int l_CheckCollisionPointTriangleU(lua_State *L) {
...
static int l_LoadModelFromMesh(lua_State *L) {
  Mesh mesh = (*(Mesh*)luaL_checkudata(L, 1, "Mesh"));
...
static int l_DrawSphereWiresU(lua_State *L) {
...
static int l_ImageCopy(lua_State *L) {
  Image image = (*(Image*)luaL_checkudata(L, 1, "Image"));
...
static int l_ExportWaveAsCode(lua_State *L) {
  Wave wave = (*(Wave*)luaL_checkudata(L, 1, "Wave"));
  const char* fileName = luaL_checkstring(L, 2);
...
static int l_DrawCircleVU(lua_State *L) {
  Vector2 center = {luaL_checknumber(L, 1),luaL_checknumber(L, 2)};
  float radius = luaL_checknumber(L, 3);
  Color color = {luaL_checkinteger(L, 4),luaL_checkinteger(L, 5),luaL_checkinteger(L, 6),luaL_checkinteger(L, 7)};
  DrawCircleV(center, radius, color);
...
static int l_GetFileModTime(lua_State *L) {
  const char* fileName = luaL_checkstring(L, 1);
...
static int l_ImageAlphaPremultiply(lua_State *L) {
  Image* image = (Image*)luaL_checkudata(L, 1, "Image");
...
// Get default texture
static int l_GetTextureDefault(lua_State *L) {
...
static int l_GetTextureDefaultU(lua_State *L) {
  Texture2D result = GetTextureDefault();
  Texture2D* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = result; luaL_setmetatable(L, "Texture2D");
  lua_pushinteger(L, result.id);lua_pushinteger(L, result.width);lua_pushinteger(L, result.height);lua_pushinteger(L, result.mipmaps);lua_pushinteger(L, result.format);
  return 5;
...
static int l_LoadTextureU(lua_State *L) {
  const char* fileName = luaL_checkstring(L, 1);
  Texture2D result = LoadTexture(fileName);
  Texture2D* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = result; luaL_setmetatable(L, "Texture2D");
  lua_pushinteger(L, result.id);lua_pushinteger(L, result.width);lua_pushinteger(L, result.height);lua_pushinteger(L, result.mipmaps);lua_pushinteger(L, result.format);
...
static int l_GenImageFontAtlas(lua_State *L) {
...
static int l_GetDirectoryPath(lua_State *L) {
  const char* fileName = luaL_checkstring(L, 1);
...
static int l_ImageAlphaClear(lua_State *L) {
  Image* image = (Image*)luaL_checkudata(L, 1, "Image");
  Color color = (*(Color*)luaL_checkudata(L, 2, "Color"));
...
static int l_ImageAlphaClearU(lua_State *L) {
  Image* image = (Image*)luaL_checkudata(L, 1, "Image");
  Color color = {luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5)};
...
static int l_LoadMeshes(lua_State *L) {
  const char* fileName = luaL_checkstring(L, 1);
  int* meshCount = (int*)luaL_checkudata(L, 2, "int");
  Mesh* result = LoadMeshes(fileName, meshCount);
  if (result == NULL) lua_pushnil(L); else { Mesh* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = *result; luaL_setmetatable(L, "Mesh");}
  return 1;
}

// Resize image (Nearest-Neighbor scaling algorithm)
static int l_ImageResizeNN(lua_State *L) {
  Image* image = (Image*)luaL_checkudata(L, 1, "Image");
...
static int l_EndVrDrawing(lua_State *L) {
  (void)L; // Suppress unused warning
  EndVrDrawing();
  return 0;
}
...
static int l_ExportImage(lua_State *L) {
  Image image = (*(Image*)luaL_checkudata(L, 1, "Image"));
  const char* fileName = luaL_checkstring(L, 2);
...
static int l_GetColorU(lua_State *L) {
  int hexValue = luaL_checkinteger(L, 1);
  Color result = GetColor(hexValue);
  Color* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = result; luaL_setmetatable(L, "Color");
  lua_pushinteger(L, result.r);lua_pushinteger(L, result.g);lua_pushinteger(L, result.b);lua_pushinteger(L, result.a);
...
// Resume audio stream
static int l_ResumeAudioStream(lua_State *L) {
  AudioStream stream = (*(AudioStream*)luaL_checkudata(L, 1, "AudioStream"));
...
static int l_DrawSphereU(lua_State *L) {
  Vector3 centerPos = {luaL_checknumber(L, 1),luaL_checknumber(L, 2),luaL_checknumber(L, 3)};
  float radius = luaL_checknumber(L, 4);
  Color color = {luaL_checkinteger(L, 5),luaL_checkinteger(L, 6),luaL_checkinteger(L, 7),luaL_checkinteger(L, 8)};
  DrawSphere(centerPos, radius, color);
...
static int l_SetShaderValueIVec3(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
...
static int l_SetShaderValueIVec3U(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
  int uniformLoc = luaL_checkinteger(L, 2);
...
static int l_GenMeshCylinder(lua_State *L) {
  float radius = luaL_checknumber(L, 1);
...
static int l_SetShaderValueTextureU(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
  int uniformLoc = luaL_checkinteger(L, 2);
...
static int l_GetWindowHandle(lua_State *L) {
...
static int l_UnloadModelAnimation(lua_State *L) {
...
static int l_DrawBillboardRec(lua_State *L) {
  Camera3D camera = (*(Camera3D*)luaL_checkudata(L, 1, "Camera3D"));
...
static int l_DrawBillboardRecU(lua_State *L) {
  Camera3D camera = (*(Camera3D*)luaL_checkudata(L, 1, "Camera3D"));
...
static int l_DrawCylinderU(lua_State *L) {
  Vector3 position = {luaL_checknumber(L, 1),luaL_checknumber(L, 2),luaL_checknumber(L, 3)};
...
static int l_GetPixelDataSize(lua_State *L) {
  int width = luaL_checkinteger(L, 1);
  int height = luaL_checkinteger(L, 2);
...
static int l_DrawRingLinesU(lua_State *L) {
  Vector2 center = {luaL_checknumber(L, 1),luaL_checknumber(L, 2)};
...
static int l_DrawRectangleRoundedLinesU(lua_State *L) {
  Rectangle rec = {luaL_checknumber(L, 1),luaL_checknumber(L, 2),luaL_checknumber(L, 3),luaL_checknumber(L, 4)};
...
static int l_ColorNormalize(lua_State *L) {
  Color color = (*(Color*)luaL_checkudata(L, 1, "Color"));
...
static int l_ColorNormalizeU(lua_State *L) {
  Color color = {luaL_checkinteger(L, 1),luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4)};
  Vector4 result = ColorNormalize(color);
  Vector4* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = result; luaL_setmetatable(L, "Vector4");
...
static int l_SetShaderValueFloat(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
  int uniformLoc = luaL_checkinteger(L, 2);
...
static int l_SetShaderValueVec3(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
  int uniformLoc = luaL_checkinteger(L, 2);
...
static int l_SetShaderValueVec3U(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
  int uniformLoc = luaL_checkinteger(L, 2);
...
static int l_GetTextureData(lua_State *L) {
  Texture2D texture = (*(Texture2D*)luaL_checkudata(L, 1, "Texture2D"));
...
static int l_GetTextureDataU(lua_State *L) {
  Texture2D texture = {luaL_checkinteger(L, 1),luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5)};
  Image result = GetTextureData(texture);
  Image* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = result; luaL_setmetatable(L, "Image");
  return 1;
...
static int l_DrawRectangleProU(lua_State *L) {
  Rectangle rec = {luaL_checknumber(L, 1),luaL_checknumber(L, 2),luaL_checknumber(L, 3),luaL_checknumber(L, 4)};
...
static int l_UpdateTexture(lua_State *L) {
  Texture2D texture = (*(Texture2D*)luaL_checkudata(L, 1, "Texture2D"));
...
static int l_UpdateTextureU(lua_State *L) {
  Texture2D texture = {luaL_checkinteger(L, 1),luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5)};
...
static int l_DrawLineVU(lua_State *L) {
  Vector2 startPos = {luaL_checknumber(L, 1),luaL_checknumber(L, 2)};
  Vector2 endPos = {luaL_checknumber(L, 3),luaL_checknumber(L, 4)};
  Color color = {luaL_checkinteger(L, 5),luaL_checkinteger(L, 6),luaL_checkinteger(L, 7),luaL_checkinteger(L, 8)};
  DrawLineV(startPos, endPos, color);
...
static int l_SetShaderValueInt(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
  int uniformLoc = luaL_checkinteger(L, 2);
...
// Draw simple gizmo
static int l_DrawGizmo(lua_State *L) {
  Vector3 position = (*(Vector3*)luaL_checkudata(L, 1, "Vector3"));
  DrawGizmo(position);
  return 0;
}
...
static int l_DrawGizmoU(lua_State *L) {
  Vector3 position = {luaL_checknumber(L, 1),luaL_checknumber(L, 2),luaL_checknumber(L, 3)};
  DrawGizmo(position);
  return 0;
}

static int l_SetShaderValueSampler2D(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
  int uniformLoc = luaL_checkinteger(L, 2);
  int value = luaL_checkinteger(L, 3);
...
static int l_SetShaderValueVec2(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
  int uniformLoc = luaL_checkinteger(L, 2);
...
static int l_SetShaderValueVec2U(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
  int uniformLoc = luaL_checkinteger(L, 2);
...
static int l_GetGestureDragAngle(lua_State *L) {
  float result = GetGestureDragAngle();
  lua_pushnumber(L, result);
  return 1;
}

static int l_SetShaderValueIVec2(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
  int uniformLoc = luaL_checkinteger(L, 2);
...
static int l_SetShaderValueIVec2U(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
  int uniformLoc = luaL_checkinteger(L, 2);
...
static int l_DrawCircleSectorU(lua_State *L) {
  Vector2 center = {luaL_checknumber(L, 1),luaL_checknumber(L, 2)};
  float radius = luaL_checknumber(L, 3);
  int startAngle = luaL_checkinteger(L, 4);
  int endAngle = luaL_checkinteger(L, 5);
...
static int l_DrawCubeVU(lua_State *L) {
  Vector3 position = {luaL_checknumber(L, 1),luaL_checknumber(L, 2),luaL_checknumber(L, 3)};
  Vector3 size = {luaL_checknumber(L, 4),luaL_checknumber(L, 5),luaL_checknumber(L, 6)};
  Color color = {luaL_checkinteger(L, 7),luaL_checkinteger(L, 8),luaL_checkinteger(L, 9),luaL_checkinteger(L, 10)};
  DrawCubeV(position, size, color);
...
static int l_IsFileExtension(lua_State *L) {
  const char* fileName = luaL_checkstring(L, 1);
...
static int l_GetMonitorName(lua_State *L) {
...
static int l_WaveFormat(lua_State *L) {
  Wave* wave = (Wave*)luaL_checkudata(L, 1, "Wave");
...
static int l_WaveCrop(lua_State *L) {
  Wave* wave = (Wave*)luaL_checkudata(L, 1, "Wave");
...
static int l_WaveCopy(lua_State *L) {
  Wave wave = (*(Wave*)luaL_checkudata(L, 1, "Wave"));
...
static int l_GenMeshPoly(lua_State *L) {
...
static int l_ImageDrawTextEx(lua_State *L) {
...
static int l_ImageDrawTextExU(lua_State *L) {
  Image* dst = (Image*)luaL_checkudata(L, 1, "Image");
...
static int l_UpdateVrTracking(lua_State *L) {
  Camera3D* camera = (Camera3D*)luaL_checkudata(L, 1, "Camera3D");
...
static int l_SetAudioStreamPitch(lua_State *L) {
  AudioStream stream = (*(AudioStream*)luaL_checkudata(L, 1, "AudioStream"));
...
static int l_DrawSphereExU(lua_State *L) {
  Vector3 centerPos = {luaL_checknumber(L, 1),luaL_checknumber(L, 2),luaL_checknumber(L, 3)};
  float radius = luaL_checknumber(L, 4);
  int rings = luaL_checkinteger(L, 5);
  int slices = luaL_checkinteger(L, 6);
...
static int l_UpdateSound(lua_State *L) {
  Sound sound = (*(Sound*)luaL_checkudata(L, 1, "Sound"));
...
static int l_ImageToPOTU(lua_State *L) {
  Image* image = (Image*)luaL_checkudata(L, 1, "Image");
...
static int l_GenMeshCube(lua_State *L) {
...
static int l_UpdateModelAnimation(lua_State *L) {
  Model model = (*(Model*)luaL_checkudata(L, 1, "Model"));
...
static int l_GenImageChecked(lua_State *L) {
  int width = luaL_checkinteger(L, 1);
  int height = luaL_checkinteger(L, 2);
...
static int l_GenImageCheckedU(lua_State *L) {
  int width = luaL_checkinteger(L, 1);
  int height = luaL_checkinteger(L, 2);
  int checksX = luaL_checkinteger(L, 3);
  int checksY = luaL_checkinteger(L, 4);
...
// Generate torus mesh
static int l_GenMeshTorus(lua_State *L) {
  float radius = luaL_checknumber(L, 1);
...
static int l_UpdateAudioStream(lua_State *L) {
  AudioStream stream = (*(AudioStream*)luaL_checkudata(L, 1, "AudioStream"));
  const void* data = luaX_checklightuserdata(L, 2, "?");
  int samplesCount = luaL_checkinteger(L, 3);
...
static int l_SetShaderValueIVec4(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
  int uniformLoc = luaL_checkinteger(L, 2);
...
static int l_SetShaderValueIVec4U(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
  int uniformLoc = luaL_checkinteger(L, 2);
...
static int l_SetTraceLogLevel(lua_State *L) {
  int logType = luaL_checkinteger(L, 1);
...
static int l_IsVrSimulatorReady(lua_State *L) {
...
static int l_CheckCollisionPointRecU(lua_State *L) {
  Vector2 point = {luaL_checknumber(L, 1),luaL_checknumber(L, 2)};
...
static int l_ColorFromHSV(lua_State *L) {
...
static int l_ColorFromHSVU(lua_State *L) {
...
static int l_ImageDither(lua_State *L) {
  Image* image = (Image*)luaL_checkudata(L, 1, "Image");
...
static int l_DrawTriangleFan(lua_State *L) {
...
static int l_GenImageGradientVU(lua_State *L) {
  int width = luaL_checkinteger(L, 1);
  int height = luaL_checkinteger(L, 2);
...
static int l_SetWindowIcon(lua_State *L) {
  Image image = (*(Image*)luaL_checkudata(L, 1, "Image"));
  SetWindowIcon(image);
  return 0;
}
...
static int l_TextReplace(lua_State *L) {
...
static int l_StorageLoadValue(lua_State *L) {
  int position = luaL_checkinteger(L, 1);
...
static int l_TextToPascal(lua_State *L) {
  const char* text = luaL_checkstring(L, 1);
...
static int l_GenTexturePrefilter(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
  Texture2D cubemap = (*(Texture2D*)luaL_checkudata(L, 2, "Texture2D"));
  int size = luaL_checkinteger(L, 3);
...
static int l_GenTexturePrefilterU(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
  Texture2D cubemap = {luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5),luaL_checkinteger(L, 6)};
  int size = luaL_checkinteger(L, 7);
  Texture2D result = GenTexturePrefilter(shader, cubemap, size);
...
static int l_GetFileName(lua_State *L) {
...
static int l_TextToInteger(lua_State *L) {
  const char* text = luaL_checkstring(L, 1);
...
static int l_TextSubtext(lua_State *L) {
  const char* text = luaL_checkstring(L, 1);
...
static int l_DrawRectangleLinesExU(lua_State *L) {
  Rectangle rec = {luaL_checknumber(L, 1),luaL_checknumber(L, 2),luaL_checknumber(L, 3),luaL_checknumber(L, 4)};
...
// Show the window
static int l_UnhideWindow(lua_State *L) {
  (void)L; // Suppress unused warning
  UnhideWindow();
  return 0;
}
...
static int l_DrawRectangleGradientExU(lua_State *L) {
  Rectangle rec = {luaL_checknumber(L, 1),luaL_checknumber(L, 2),luaL_checknumber(L, 3),luaL_checknumber(L, 4)};
  Color col1 = {luaL_checkinteger(L, 5),luaL_checkinteger(L, 6),luaL_checkinteger(L, 7),luaL_checkinteger(L, 8)};
  Color col2 = {luaL_checkinteger(L, 9),luaL_checkinteger(L, 10),luaL_checkinteger(L, 11),luaL_checkinteger(L, 12)};
...
static int l_TextLength(lua_State *L) {
  const char* text = luaL_checkstring(L, 1);
...
static int l_CheckCollisionCircleRecU(lua_State *L) {
  Vector2 center = {luaL_checknumber(L, 1),luaL_checknumber(L, 2)};
  float radius = luaL_checknumber(L, 3);
...
static int l_ChangeDirectory(lua_State *L) {
...
static int l_GetCollisionRecU(lua_State *L) {
  Rectangle rec1 = {luaL_checknumber(L, 1),luaL_checknumber(L, 2),luaL_checknumber(L, 3),luaL_checknumber(L, 4)};
  Rectangle rec2 = {luaL_checknumber(L, 5),luaL_checknumber(L, 6),luaL_checknumber(L, 7),luaL_checknumber(L, 8)};
  Rectangle result = GetCollisionRec(rec1, rec2);
  Rectangle* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = result; luaL_setmetatable(L, "Rectangle");
...
static int l_TextCountCodepoints(lua_State *L) {
  const char* text = luaL_checkstring(L, 1);
...
static int l_TextAppend(lua_State *L) {
...
static int l_ImageDrawRectangleLines(lua_State *L) {
  Image* dst = (Image*)luaL_checkudata(L, 1, "Image");
  Rectangle rec = (*(Rectangle*)luaL_checkudata(L, 2, "Rectangle"));
...
static int l_ImageDrawRectangleLinesU(lua_State *L) {
  Image* dst = (Image*)luaL_checkudata(L, 1, "Image");
...
static int l_IsGestureDetected(lua_State *L) {
...
static int l_ClearDirectoryFiles(lua_State *L) {
  (void)L; // Suppress unused warning
  ClearDirectoryFiles();
  return 0;
}
...
static int l_DrawModelWires(lua_State *L) {
  Model model = (*(Model*)luaL_checkudata(L, 1, "Model"));
  Vector3 position = (*(Vector3*)luaL_checkudata(L, 2, "Vector3"));
...
static int l_DrawModelWiresU(lua_State *L) {
  Model model = (*(Model*)luaL_checkudata(L, 1, "Model"));
  Vector3 position = {luaL_checknumber(L, 2),luaL_checknumber(L, 3),luaL_checknumber(L, 4)};
  float scale = luaL_checknumber(L, 5);
...
static int l_SetWindowMonitor(lua_State *L) {
  int monitor = luaL_checkinteger(L, 1);
...
static int l_UnloadFont(lua_State *L) {
  Font font = (*(Font*)luaL_checkudata(L, 1, "Font"));
  UnloadFont(font);
  return 0;
}
...
static int l_DrawTriangleU(lua_State *L) {
...
static int l_SetTextureFilterU(lua_State *L) {
  Texture2D texture = {luaL_checkinteger(L, 1),luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5)};
...
static int l_LoadImageRaw(lua_State *L) {
  const char* fileName = luaL_checkstring(L, 1);
...
static int l_DrawLineBezierU(lua_State *L) {
  Vector2 startPos = {luaL_checknumber(L, 1),luaL_checknumber(L, 2)};
  Vector2 endPos = {luaL_checknumber(L, 3),luaL_checknumber(L, 4)};
  float thick = luaL_checknumber(L, 5);
  Color color = {luaL_checkinteger(L, 6),luaL_checkinteger(L, 7),luaL_checkinteger(L, 8),luaL_checkinteger(L, 9)};
...
static int l_GetCollisionRayTriangle(lua_State *L) {
  Ray ray = (*(Ray*)luaL_checkudata(L, 1, "Ray"));
...
static int l_GetCollisionRayTriangleU(lua_State *L) {
  Ray ray = (*(Ray*)luaL_checkudata(L, 1, "Ray"));
...
static int l_DrawPixelVU(lua_State *L) {
...
static int l_InitVrSimulator(lua_State *L) {
  (void)L; // Suppress unused warning
  InitVrSimulator();
  return 0;
}
...
static int l_GetGestureHoldDuration(lua_State *L) {
...
static int l_SetShapesTexture(lua_State *L) {
  Texture2D texture = (*(Texture2D*)luaL_checkudata(L, 1, "Texture2D"));
...
static int l_SetShapesTextureU(lua_State *L) {
  Texture2D texture = {luaL_checkinteger(L, 1),luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5)};
...
static int l_GetTouchPositionU(lua_State *L) {
  int index = luaL_checkinteger(L, 1);
  Vector2 result = GetTouchPosition(index);
  Vector2* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = result; luaL_setmetatable(L, "Vector2");
  lua_pushnumber(L, result.x);lua_pushnumber(L, result.y);
...
static int l_SetShaderValueMatrixU(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
  int uniformLoc = luaL_checkinteger(L, 2);
...
// Draw a color-filled rectangle (unpacked version)
static int l_DrawRectangleU(lua_State *L) {
  int posX = luaL_checkinteger(L, 1);
  int posY = luaL_checkinteger(L, 2);
  int width = luaL_checkinteger(L, 3);
  int height = luaL_checkinteger(L, 4);
...
static int l_SetGesturesEnabled(lua_State *L) {
...
static int l_DrawRectangleLinesU(lua_State *L) {
  int posX = luaL_checkinteger(L, 1);
  int posY = luaL_checkinteger(L, 2);
  int width = luaL_checkinteger(L, 3);
  int height = luaL_checkinteger(L, 4);
...
static int l_DrawTextureNPatch(lua_State *L) {
  Texture2D texture = (*(Texture2D*)luaL_checkudata(L, 1, "Texture2D"));
...
static int l_DrawTextureNPatchU(lua_State *L) {
  Texture2D texture = {luaL_checkinteger(L, 1),luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5)};
...
static int l_MeshBinormals(lua_State *L) {
  Mesh* mesh = (Mesh*)luaL_checkudata(L, 1, "Mesh");
  MeshBinormals(mesh);
  return 0;
}
...
static int l_DrawPolyU(lua_State *L) {
  Vector2 center = {luaL_checknumber(L, 1),luaL_checknumber(L, 2)};
...
static int l_LoadModelAnimations(lua_State *L) {
  int count = 0;
...
static int l_LoadWaveEx(lua_State *L) {
...
static int l_SetMusicPitch(lua_State *L) {
  Music music = ((OpaqueMusic*)luaL_checkudata(L, 1, "Music"))->data;
  float pitch = luaL_checknumber(L, 2);
...
static int l_DrawModelU(lua_State *L) {
  Model model = (*(Model*)luaL_checkudata(L, 1, "Model"));
  Vector3 position = {luaL_checknumber(L, 2),luaL_checknumber(L, 3),luaL_checknumber(L, 4)};
  float scale = luaL_checknumber(L, 5);
  Color tint = {luaL_checkinteger(L, 6),luaL_checkinteger(L, 7),luaL_checkinteger(L, 8),luaL_checkinteger(L, 9)};
...
static int l_GenTextureCubemap(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
...
static int l_GenTextureCubemapU(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
...
static int l_SetMusicLoopCount(lua_State *L) {
  Music music = ((OpaqueMusic*)luaL_checkudata(L, 1, "Music"))->data;
...
static int l_SetModelMeshMaterial(lua_State *L) {
  Model* model = (Model*)luaL_checkudata(L, 1, "Model");
...
static int l_SetMatrixModelview(lua_State *L) {
...
static int l_SetMatrixModelviewU(lua_State *L) {
...
static int l_DrawTextRecEx(lua_State *L) {
  Font font = (*(Font*)luaL_checkudata(L, 1, "Font"));
...
static int l_DrawTextRecExU(lua_State *L) {
  Font font = (*(Font*)luaL_checkudata(L, 1, "Font"));
  const char * text = (char*)luaL_checkudata(L, 2, "char");
  Rectangle rec = {luaL_checknumber(L, 3),luaL_checknumber(L, 4),luaL_checknumber(L, 5),luaL_checknumber(L, 6)};
...
static int l_DrawBoundingBox(lua_State *L) {
...
static int l_DrawBoundingBoxU(lua_State *L) {
  BoundingBox box = (*(BoundingBox*)luaL_checkudata(L, 1, "BoundingBox"));
  Color color = {luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5)};
  DrawBoundingBox(box, color);
  return 0;
...
static int l_UnloadTextureU(lua_State *L) {
  Texture2D texture = {luaL_checkinteger(L, 1),luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5)};
  UnloadTexture(texture);
  return 0;
}
...
static int l_DrawRayU(lua_State *L) {
  Ray ray = (*(Ray*)luaL_checkudata(L, 1, "Ray"));
  Color color = {luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5)};
  DrawRay(ray, color);
  return 0;
...
static int l_MeasureTextExU(lua_State *L) {
  Font font = (*(Font*)luaL_checkudata(L, 1, "Font"));
  const char* text = luaL_checkstring(L, 2);
  float fontSize = luaL_checknumber(L, 3);
  float spacing = luaL_checknumber(L, 4);
...
static int l_SetCameraSmoothZoomControl(lua_State *L) {
...
static int l_DrawTriangleLinesU(lua_State *L) {
  Vector2 v1 = {luaL_checknumber(L, 1),luaL_checknumber(L, 2)};
  Vector2 v2 = {luaL_checknumber(L, 3),luaL_checknumber(L, 4)};
  Vector2 v3 = {luaL_checknumber(L, 5),luaL_checknumber(L, 6)};
  Color color = {luaL_checkinteger(L, 7),luaL_checkinteger(L, 8),luaL_checkinteger(L, 9),luaL_checkinteger(L, 10)};
...
static int l_SetCameraPanControl(lua_State *L) {
...
static int l_SetCameraAltControl(lua_State *L) {
...
static int l_MeshTangents(lua_State *L) {
  Mesh* mesh = (Mesh*)luaL_checkudata(L, 1, "Mesh");
  MeshTangents(mesh);
  return 0;
}
...
// Play audio stream
static int l_PlayAudioStream(lua_State *L) {
  AudioStream stream = (*(AudioStream*)luaL_checkudata(L, 1, "AudioStream"));
...
static int l_CheckCollisionBoxSphere(lua_State *L) {
  BoundingBox box = (*(BoundingBox*)luaL_checkudata(L, 1, "BoundingBox"));
...
static int l_CheckCollisionBoxSphereU(lua_State *L) {
  BoundingBox box = (*(BoundingBox*)luaL_checkudata(L, 1, "BoundingBox"));
...
static int l_ImageDraw(lua_State *L) {
  Image* dst = (Image*)luaL_checkudata(L, 1, "Image");
...
static int l_ImageDrawU(lua_State *L) {
  Image* dst = (Image*)luaL_checkudata(L, 1, "Image");
  Image src = (*(Image*)luaL_checkudata(L, 2, "Image"));
...
static int l_ImageDrawText(lua_State *L) {
  Image* dst = (Image*)luaL_checkudata(L, 1, "Image");
  Vector2 position = (*(Vector2*)luaL_checkudata(L, 2, "Vector2"));
...
static int l_ImageDrawTextU(lua_State *L) {
  Image* dst = (Image*)luaL_checkudata(L, 1, "Image");
  Vector2 position = {luaL_checknumber(L, 2),luaL_checknumber(L, 3)};
  const char* text = luaL_checkstring(L, 4);
...
// Pause audio stream
static int l_PauseAudioStream(lua_State *L) {
  AudioStream stream = (*(AudioStream*)luaL_checkudata(L, 1, "AudioStream"));
...
static int l_DrawTextureExU(lua_State *L) {
  Texture2D texture = {luaL_checkinteger(L, 1),luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5)};
...
static int l_SetAudioStreamVolume(lua_State *L) {
  AudioStream stream = (*(AudioStream*)luaL_checkudata(L, 1, "AudioStream"));
  float volume = luaL_checknumber(L, 2);
...
static int l_GenMeshSphere(lua_State *L) {
  float radius = luaL_checknumber(L, 1);
  int rings = luaL_checkinteger(L, 2);
  int slices = luaL_checkinteger(L, 3);
...
static int l_GenImageColorU(lua_State *L) {
  int width = luaL_checkinteger(L, 1);
  int height = luaL_checkinteger(L, 2);
  Color color = {luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5),luaL_checkinteger(L, 6)};
  Image result = GenImageColor(width, height, color);
...
static int l_GetWorkingDirectory(lua_State *L) {
...
static int l_SetSoundPitch(lua_State *L) {
  Sound sound = (*(Sound*)luaL_checkudata(L, 1, "Sound"));
  float pitch = luaL_checknumber(L, 2);
...
static int l_LoadImageEx(lua_State *L) {
...
static int l_LoadTextureFromImageU(lua_State *L) {
  Image image = (*(Image*)luaL_checkudata(L, 1, "Image"));
  Texture2D result = LoadTextureFromImage(image);
  Texture2D* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = result; luaL_setmetatable(L, "Texture2D");
  lua_pushinteger(L, result.id);lua_pushinteger(L, result.width);lua_pushinteger(L, result.height);lua_pushinteger(L, result.mipmaps);lua_pushinteger(L, result.format);
...
static int l_LoadTextureCubemap(lua_State *L) {
  Image image = (*(Image*)luaL_checkudata(L, 1, "Image"));
...
static int l_LoadTextureCubemapU(lua_State *L) {
  Image image = (*(Image*)luaL_checkudata(L, 1, "Image"));
  int layoutType = luaL_checkinteger(L, 2);
  Texture2D result = LoadTextureCubemap(image, layoutType);
  Texture2D* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = result; luaL_setmetatable(L, "Texture2D");
...
static int l_GetGesturePinchVector(lua_State *L) {
...
static int l_GetGesturePinchVectorU(lua_State *L) {
  Vector2 result = GetGesturePinchVector();
  Vector2* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = result; luaL_setmetatable(L, "Vector2");
  lua_pushnumber(L, result.x);lua_pushnumber(L, result.y);
  return 2;
...
static int l_LoadShaderCode(lua_State *L) {
...
static int l_DrawCircleLinesU(lua_State *L) {
  int centerX = luaL_checkinteger(L, 1);
  int centerY = luaL_checkinteger(L, 2);
  float radius = luaL_checknumber(L, 3);
  Color color = {luaL_checkinteger(L, 4),luaL_checkinteger(L, 5),luaL_checkinteger(L, 6),luaL_checkinteger(L, 7)};
...
static int l_GetGesturePinchAngle(lua_State *L) {
...
static int l_SetShaderValueV(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
  int uniformLoc = luaL_checkinteger(L, 2);
  const void* value = luaX_checklightuserdata(L, 3, "?");
  int uniformType = luaL_checkinteger(L, 4);
...
static int l_LoadMaterials(lua_State *L) {
  int count;
...
static int l_DrawBillboardU(lua_State *L) {
  Camera3D camera = (*(Camera3D*)luaL_checkudata(L, 1, "Camera3D"));
  Texture2D texture = {luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5),luaL_checkinteger(L, 6)};
...
static int l_LoadMaterialDefault(lua_State *L) {
...
static int l_DrawRectangleGradientHU(lua_State *L) {
  int posX = luaL_checkinteger(L, 1);
  int posY = luaL_checkinteger(L, 2);
  int width = luaL_checkinteger(L, 3);
  int height = luaL_checkinteger(L, 4);
...
static int l_GetMatrixModelview(lua_State *L) {
...
static int l_GetMatrixModelviewU(lua_State *L) {
  Matrix result = GetMatrixModelview();
  Matrix* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = result; luaL_setmetatable(L, "Matrix");
  lua_pushnumber(L, result.m0);lua_pushnumber(L, result.m4);lua_pushnumber(L, result.m8);lua_pushnumber(L, result.m12);lua_pushnumber(L, result.m1);lua_pushnumber(L, result.m5);lua_pushnumber(L, result.m9);lua_pushnumber(L, result.m13);lua_pushnumber(L, result.m2);lua_pushnumber(L, result.m6);lua_pushnumber(L, result.m10);lua_pushnumber(L, result.m14);lua_pushnumber(L, result.m3);lua_pushnumber(L, result.m7);lua_pushnumber(L, result.m11);lua_pushnumber(L, result.m15);
  return 16;
...
static int l_ClearBackgroundU(lua_State *L) {
  Color color = {luaL_checkinteger(L, 1),luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4)};
  ClearBackground(color);
  return 0;
}
...
static int l_LoadFontFromImage(lua_State *L) {
  Image image = (*(Image*)luaL_checkudata(L, 1, "Image"));
...
static int l_LoadFontFromImageU(lua_State *L) {
  Image image = (*(Image*)luaL_checkudata(L, 1, "Image"));
...
static int l_DrawTextU(lua_State *L) {
  const char* text = luaL_checkstring(L, 1);
  int posX = luaL_checkinteger(L, 2);
  int posY = luaL_checkinteger(L, 3);
  int fontSize = luaL_checkinteger(L, 4);
...
static int l_DrawCircleGradientU(lua_State *L) {
  int centerX = luaL_checkinteger(L, 1);
  int centerY = luaL_checkinteger(L, 2);
  float radius = luaL_checknumber(L, 3);
...
static int l_ExportMesh(lua_State *L) {
  Mesh mesh = (*(Mesh*)luaL_checkudata(L, 1, "Mesh"));
  const char* fileName = luaL_checkstring(L, 2);
...
static int l_UnloadModel(lua_State *L) {
  Model model = (*(Model*)luaL_checkudata(L, 1, "Model"));
  UnloadModel(model);
  return 0;
}
...
static int l_GetMonitorPhysicalWidth(lua_State *L) {
  int monitor = luaL_checkinteger(L, 1);
...
static int l_TextSplit(lua_State *L) {
...
static int l_DrawRingU(lua_State *L) {
  Vector2 center = {luaL_checknumber(L, 1),luaL_checknumber(L, 2)};
  float innerRadius = luaL_checknumber(L, 3);
  float outerRadius = luaL_checknumber(L, 4);
  int startAngle = luaL_checkinteger(L, 5);
...
static int l_DrawTextureU(lua_State *L) {
  Texture2D texture = {luaL_checkinteger(L, 1),luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5)};
...
static int l_IsModelAnimationValid(lua_State *L) {
  Model model = (*(Model*)luaL_checkudata(L, 1, "Model"));
  ModelAnimation anim = (*(ModelAnimation*)luaL_checkudata(L, 2, "ModelAnimation"));
...
static int l_SetCameraMoveControls(lua_State *L) {
...
static int l_BeginVrDrawing(lua_State *L) {
  (void)L; // Suppress unused warning
  BeginVrDrawing();
  return 0;
}
...
static int l_TextToUpper(lua_State *L) {
  const char* text = luaL_checkstring(L, 1);
...
static int l_GetMousePositionU(lua_State *L) {
  Vector2 result = GetMousePosition();
  Vector2* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = result; luaL_setmetatable(L, "Vector2");
  lua_pushnumber(L, result.x);lua_pushnumber(L, result.y);
  return 2;
...
static int l_CheckCollisionRaySphereEx(lua_State *L) {
  Ray ray = (*(Ray*)luaL_checkudata(L, 1, "Ray"));
...
static int l_IsGamepadName(lua_State *L) {
  int gamepad = luaL_checkinteger(L, 1);
...
static int l_DrawRectangleVU(lua_State *L) {
  Vector2 position = {luaL_checknumber(L, 1),luaL_checknumber(L, 2)};
...
// Get default shader
static int l_GetShaderDefault(lua_State *L) {
...
static int l_SetTextureWrapU(lua_State *L) {
  Texture2D texture = {luaL_checkinteger(L, 1),luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5)};
...
static int l_GetGamepadButtonPressed(lua_State *L) {
...
static int l_DrawCylinderWiresU(lua_State *L) {
  Vector3 position = {luaL_checknumber(L, 1),luaL_checknumber(L, 2),luaL_checknumber(L, 3)};
  float radiusTop = luaL_checknumber(L, 4);
  float radiusBottom = luaL_checknumber(L, 5);
  float height = luaL_checknumber(L, 6);
...
static int l_GetImageData(lua_State *L) {
  Image image = (*(Image*)luaL_checkudata(L, 1, "Image"));
...
static int l_IsFileDropped(lua_State *L) {
...
static int l_GetMonitorWidth(lua_State *L) {
  int monitor = luaL_checkinteger(L, 1);
...
static int l_CheckCollisionPointCircleU(lua_State *L) {
  Vector2 point = {luaL_checknumber(L, 1),luaL_checknumber(L, 2)};
...
static int l_TextFindIndex(lua_State *L) {
  const char* text = luaL_checkstring(L, 1);
...
static int l_GenMeshHeightmapU(lua_State *L) {
  Image heightmap = (*(Image*)luaL_checkudata(L, 1, "Image"));
...
static int l_ImageMipmaps(lua_State *L) {
  Image* image = (Image*)luaL_checkudata(L, 1, "Image");
  ImageMipmaps(image);
  return 0;
}
...
static int l_LoadImagePro(lua_State *L) {
  void* data = luaX_checklightuserdata(L, 1, "?");
  int width = luaL_checkinteger(L, 2);
  int height = luaL_checkinteger(L, 3);
  int format = luaL_checkinteger(L, 4);
...
static int l_DrawTextureQuad(lua_State *L) {
  Texture2D texture = (*(Texture2D*)luaL_checkudata(L, 1, "Texture2D"));
...
static int l_DrawTextureQuadU(lua_State *L) {
  Texture2D texture = {luaL_checkinteger(L, 1),luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5)};
...
// Draw cube textured
static int l_DrawCubeTexture(lua_State *L) {
  Texture2D texture = (*(Texture2D*)luaL_checkudata(L, 1, "Texture2D"));
  Vector3 position = (*(Vector3*)luaL_checkudata(L, 2, "Vector3"));
...
static int l_DrawCubeTextureU(lua_State *L) {
  Texture2D texture = {luaL_checkinteger(L, 1),luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5)};
...
// Hide the window
static int l_HideWindow(lua_State *L) {
  (void)L; // Suppress unused warning
  HideWindow();
  return 0;
}
...
static int l_GenMeshPlane(lua_State *L) {
  float width = luaL_checknumber(L, 1);
...
static int l_UnloadMesh(lua_State *L) {
  Mesh* mesh = (Mesh*)luaL_checkudata(L, 1, "Mesh");
  UnloadMesh(mesh);
  return 0;
}
...
static int l_ImageCropU(lua_State *L) {
  Image* image = (Image*)luaL_checkudata(L, 1, "Image");
...
static int l_ClearDroppedFiles(lua_State *L) {
  (void)L; // Suppress unused warning
  ClearDroppedFiles();
  return 0;
}
...
static int l_DrawTextureV(lua_State *L) {
  Texture2D texture = (*(Texture2D*)luaL_checkudata(L, 1, "Texture2D"));
  Vector2 position = (*(Vector2*)luaL_checkudata(L, 2, "Vector2"));
...
static int l_DrawTextureVU(lua_State *L) {
  Texture2D texture = {luaL_checkinteger(L, 1),luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5)};
  Vector2 position = {luaL_checknumber(L, 6),luaL_checknumber(L, 7)};
  Color tint = {luaL_checkinteger(L, 8),luaL_checkinteger(L, 9),luaL_checkinteger(L, 10),luaL_checkinteger(L, 11)};
  DrawTextureV(texture, position, tint);
...
static int l_DrawRectangleRoundedU(lua_State *L) {
  Rectangle rec = {luaL_checknumber(L, 1),luaL_checknumber(L, 2),luaL_checknumber(L, 3),luaL_checknumber(L, 4)};
  float roundness = luaL_checknumber(L, 5);
  int segments = luaL_checkinteger(L, 6);
  Color color = {luaL_checkinteger(L, 7),luaL_checkinteger(L, 8),luaL_checkinteger(L, 9),luaL_checkinteger(L, 10)};
...
static int l_ImageColorInvert(lua_State *L) {
  Image* image = (Image*)luaL_checkudata(L, 1, "Image");
...
static int l_ImageAlphaMask(lua_State *L) {
  Image* image = (Image*)luaL_checkudata(L, 1, "Image");
...
static int l_GetGlyphIndex(lua_State *L) {
  Font font = (*(Font*)luaL_checkudata(L, 1, "Font"));
...
static int l_GetMonitorPhysicalHeight(lua_State *L) {
  int monitor = luaL_checkinteger(L, 1);
...
static int l_GetWaveData(lua_State *L) {
  Wave wave = (*(Wave*)luaL_checkudata(L, 1, "Wave"));
  float* result = GetWaveData(wave);
  if (result == NULL) lua_pushnil(L); else { float* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = *result; luaL_setmetatable(L, "float");}
  return 1;
}

// Get touch points count
static int l_GetTouchPointsCount(lua_State *L) {
...
static int l_DrawTextExU(lua_State *L) {
  Font font = (*(Font*)luaL_checkudata(L, 1, "Font"));
  const char* text = luaL_checkstring(L, 2);
...
static int l_DrawModelWiresEx(lua_State *L) {
  Model model = (*(Model*)luaL_checkudata(L, 1, "Model"));
  Vector3 position = (*(Vector3*)luaL_checkudata(L, 2, "Vector3"));
  Vector3 rotationAxis = (*(Vector3*)luaL_checkudata(L, 3, "Vector3"));
  float rotationAngle = luaL_checknumber(L, 4);
...
static int l_DrawModelWiresExU(lua_State *L) {
  Model model = (*(Model*)luaL_checkudata(L, 1, "Model"));
  Vector3 position = {luaL_checknumber(L, 2),luaL_checknumber(L, 3),luaL_checknumber(L, 4)};
  Vector3 rotationAxis = {luaL_checknumber(L, 5),luaL_checknumber(L, 6),luaL_checknumber(L, 7)};
  float rotationAngle = luaL_checknumber(L, 8);
...
static int l_DrawLineU(lua_State *L) {
  int startPosX = luaL_checkinteger(L, 1);
  int startPosY = luaL_checkinteger(L, 2);
  int endPosX = luaL_checkinteger(L, 3);
  int endPosY = luaL_checkinteger(L, 4);
...
static int l_GetMouseRay(lua_State *L) {
...
static int l_GetMouseRayU(lua_State *L) {
...
static int l_ImageExtractPalette(lua_State *L) {
  Image image = (*(Image*)luaL_checkudata(L, 1, "Image"));
  int maxPaletteSize = luaL_checkinteger(L, 2);
  int* extractCount = (int*)luaL_checkudata(L, 3, "int");
...
static int l_GetWorldToScreen(lua_State *L) {
  Vector3 position = (*(Vector3*)luaL_checkudata(L, 1, "Vector3"));
  Camera3D camera = (*(Camera3D*)luaL_checkudata(L, 2, "Camera3D"));
...
static int l_GetWorldToScreenU(lua_State *L) {
  Vector3 position = {luaL_checknumber(L, 1),luaL_checknumber(L, 2),luaL_checknumber(L, 3)};
...
static int l_GetMonitorHeight(lua_State *L) {
  int monitor = luaL_checkinteger(L, 1);
...
static int l_ImageAlphaCrop(lua_State *L) {
  Image* image = (Image*)luaL_checkudata(L, 1, "Image");
...
static int l_LoadSoundFromWave(lua_State *L) {
  Wave wave = (*(Wave*)luaL_checkudata(L, 1, "Wave"));
...
static int l_GetCollisionRayModel(lua_State *L) {
  Ray ray = (*(Ray*)luaL_checkudata(L, 1, "Ray"));
...
static int l_DrawTextRec(lua_State *L) {
  Font font = (*(Font*)luaL_checkudata(L, 1, "Font"));
  const char* text = luaL_checkstring(L, 2);
  Rectangle rec = (*(Rectangle*)luaL_checkudata(L, 3, "Rectangle"));
  float fontSize = luaL_checknumber(L, 4);
...
static int l_DrawTextRecU(lua_State *L) {
  Font font = (*(Font*)luaL_checkudata(L, 1, "Font"));
  const char* text = luaL_checkstring(L, 2);
  Rectangle rec = {luaL_checknumber(L, 3),luaL_checknumber(L, 4),luaL_checknumber(L, 5),luaL_checknumber(L, 6)};
  float fontSize = luaL_checknumber(L, 7);
...
static int l_GetFileNameWithoutExt(lua_State *L) {
  const char* filePath = luaL_checkstring(L, 1);
...
static int l_CheckCollisionRaySphere(lua_State *L) {
  Ray ray = (*(Ray*)luaL_checkudata(L, 1, "Ray"));
  Vector3 spherePosition = (*(Vector3*)luaL_checkudata(L, 2, "Vector3"));
  float sphereRadius = luaL_checknumber(L, 3);
...
static int l_CheckCollisionRaySphereU(lua_State *L) {
  Ray ray = (*(Ray*)luaL_checkudata(L, 1, "Ray"));
...
static int l_SetShaderValueVec4(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
  int uniformLoc = luaL_checkinteger(L, 2);
...
static int l_SetShaderValueVec4U(lua_State *L) {
  Shader shader = (*(Shader*)luaL_checkudata(L, 1, "Shader"));
  int uniformLoc = luaL_checkinteger(L, 2);
...
static int l_GetExtension(lua_State *L) {
  const char* fileName = luaL_checkstring(L, 1);
...
static int l_ImageDrawRectangle(lua_State *L) {
  Image* dst = (Image*)luaL_checkudata(L, 1, "Image");
  Rectangle rec = (*(Rectangle*)luaL_checkudata(L, 2, "Rectangle"));
  Color color = (*(Color*)luaL_checkudata(L, 3, "Color"));
...
static int l_ImageDrawRectangleU(lua_State *L) {
  Image* dst = (Image*)luaL_checkudata(L, 1, "Image");
  Rectangle rec = {luaL_checknumber(L, 2),luaL_checknumber(L, 3),luaL_checknumber(L, 4),luaL_checknumber(L, 5)};
  Color color = {luaL_checkinteger(L, 6),luaL_checkinteger(L, 7),luaL_checkinteger(L, 8),luaL_checkinteger(L, 9)};
  ImageDrawRectangle(dst, rec, color);
...
static int l_GenMeshCubicmapU(lua_State *L) {
  Image cubicmap = (*(Image*)luaL_checkudata(L, 1, "Image"));
...
static int l_GenMeshKnot(lua_State *L) {
  float radius = luaL_checknumber(L, 1);
  float size = luaL_checknumber(L, 2);
  int radSeg = luaL_checkinteger(L, 3);
  int sides = luaL_checkinteger(L, 4);
...
static int l_DrawPlaneU(lua_State *L) {
  Vector3 centerPos = {luaL_checknumber(L, 1),luaL_checknumber(L, 2),luaL_checknumber(L, 3)};
...
static int l_DrawRectangleGradientVU(lua_State *L) {
  int posX = luaL_checkinteger(L, 1);
  int posY = luaL_checkinteger(L, 2);
  int width = luaL_checkinteger(L, 3);
  int height = luaL_checkinteger(L, 4);
...
static int l_GenImageGradientHU(lua_State *L) {
  int width = luaL_checkinteger(L, 1);
  int height = luaL_checkinteger(L, 2);
...
static int l_ImageColorReplace(lua_State *L) {
  Image* image = (Image*)luaL_checkudata(L, 1, "Image");
  Color color = (*(Color*)luaL_checkudata(L, 2, "Color"));
...
static int l_ImageColorReplaceU(lua_State *L) {
  Image* image = (Image*)luaL_checkudata(L, 1, "Image");
  Color color = {luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5)};
...
static int l_DrawTextureRecU(lua_State *L) {
  Texture2D texture = {luaL_checkinteger(L, 1),luaL_checkinteger(L, 2),luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5)};
  Rectangle sourceRec = {luaL_checknumber(L, 6),luaL_checknumber(L, 7),luaL_checknumber(L, 8),luaL_checknumber(L, 9)};
...
static int l_SetMaterialTexture(lua_State *L) {
  Material* material = (Material*)luaL_checkudata(L, 1, "Material");
...
static int l_SetMaterialTextureU(lua_State *L) {
  Material* material = (Material*)luaL_checkudata(L, 1, "Material");
  int mapType = luaL_checkinteger(L, 2);
  Texture2D texture = {luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5),luaL_checkinteger(L, 6),luaL_checkinteger(L, 7)};
  SetMaterialTexture(material, mapType, texture);
...
static int l_CheckCollisionSpheres(lua_State *L) {
...
static int l_CheckCollisionSpheresU(lua_State *L) {
...
static int l_DrawLine3DU(lua_State *L) {
...
static int l_DrawPixelU(lua_State *L) {
  int posX = luaL_checkinteger(L, 1);
  int posY = luaL_checkinteger(L, 2);
  Color color = {luaL_checkinteger(L, 3),luaL_checkinteger(L, 4),luaL_checkinteger(L, 5),luaL_checkinteger(L, 6)};
  DrawPixel(posX, posY, color);
...
static int l_DrawCubeU(lua_State *L) {
  Vector3 position = {luaL_checknumber(L, 1),luaL_checknumber(L, 2),luaL_checknumber(L, 3)};
  float width = luaL_checknumber(L, 4);
  float height = luaL_checknumber(L, 5);
  float length = luaL_checknumber(L, 6);
...
static int l_ImageResizeCanvas(lua_State *L) {
  Image* image = (Image*)luaL_checkudata(L, 1, "Image");
  int newWidth = luaL_checkinteger(L, 2);
  int newHeight = luaL_checkinteger(L, 3);
...
static int l_ImageResizeCanvasU(lua_State *L) {
  Image* image = (Image*)luaL_checkudata(L, 1, "Image");
  int newWidth = luaL_checkinteger(L, 2);
  int newHeight = luaL_checkinteger(L, 3);
  int offsetX = luaL_checkinteger(L, 4);
...
static int l_IVector3_new(lua_State *L) {
...
static int l_IVector3_meta(lua_State *L) {
...
static int l_Image_meta(lua_State *L) {
  luaL_getmetatable(L, "Image");
  return 1;
}
static int l_Wave_new(lua_State *L) {
...
static int l_Wave_meta(lua_State *L) {
  luaL_getmetatable(L, "Wave");
  return 1;
}
static int l_CharInfo_new(lua_State *L) {
...
static int l_CharInfo_meta(lua_State *L) {
  luaL_getmetatable(L, "CharInfo");
  return 1;
}
static int l_IVector2_new(lua_State *L) {
...
static int l_IVector2_meta(lua_State *L) {
  luaL_getmetatable(L, "IVector2");
  return 1;
}
static int l_IVector4_new(lua_State *L) {
...
static int l_IVector4_meta(lua_State *L) {
  luaL_getmetatable(L, "IVector4");
  return 1;
}
static int l_VrDeviceInfo_new(lua_State *L) {
...
static int l_VrDeviceInfo_meta(lua_State *L) {
  luaL_getmetatable(L, "VrDeviceInfo");
  return 1;
}
static int l_NPatchInfo_new(lua_State *L) {
...
static int l_NPatchInfo_meta(lua_State *L) {
...
static int l_Material_meta(lua_State *L) {
...
static int l_Vector2_meta(lua_State *L) {
...
static int l_Rectangle_meta(lua_State *L) {
  luaL_getmetatable(L, "Rectangle");
  return 1;
}
static int l_BoundingBox_new(lua_State *L) {
...
static int l_BoundingBox_meta(lua_State *L) {
...
static int l_Camera2D_meta(lua_State *L) {
...
static int l_Vector3_meta(lua_State *L) {
  luaL_getmetatable(L, "Vector3");
  return 1;
}
static int l_Camera3D_new(lua_State *L) {
...
static int l_Camera3D_meta(lua_State *L) {
...
static int l_Mesh_meta(lua_State *L) {
  luaL_getmetatable(L, "Mesh");
  return 1;
}
static int l_AudioStream_new(lua_State *L) {
...
static int l_AudioStream_meta(lua_State *L) {
  luaL_getmetatable(L, "AudioStream");
  return 1;
}
static int l_Texture2D_new(lua_State *L) {
...
static int l_Texture2D_meta(lua_State *L) {
...
static int l_Font_meta(lua_State *L) {
...
static int l_Sound_meta(lua_State *L) {
  luaL_getmetatable(L, "Sound");
  return 1;
}
static int l_BoneInfo_new(lua_State *L) {
...
static int l_BoneInfo_meta(lua_State *L) {
  luaL_getmetatable(L, "BoneInfo");
  return 1;
}
static int l_MaterialMap_new(lua_State *L) {
...
static int l_MaterialMap_meta(lua_State *L) {
  luaL_getmetatable(L, "MaterialMap");
  return 1;
}
static int l_RenderTexture2D_new(lua_State *L) {
...
static int l_RenderTexture2D_meta(lua_State *L) {
  luaL_getmetatable(L, "RenderTexture2D");
  return 1;
}
static int l_RayHitInfo_new(lua_State *L) {
...
static int l_RayHitInfo_meta(lua_State *L) {
...
static int l_Vector4_meta(lua_State *L) {
...
static int l_ModelAnimation_new(lua_State *L) {
...
static int l_ModelAnimation_meta(lua_State *L) {
...
static int l_Matrix_meta(lua_State *L) {
...
static int l_Color_meta(lua_State *L) {
...
static int l_Transform_meta(lua_State *L) {
  luaL_getmetatable(L, "Transform");
  return 1;
}
static int l_Ray_new(lua_State *L) {
...
static int l_Ray_meta(lua_State *L) {
...
static const luaL_Reg l_raylib_functions[] = {
  ...
  {"CloseVrSimulator", l_CloseVrSimulator},
  {"ImageColorTint", l_ImageColorTint},
  {"ImageRotateCCW", l_ImageRotateCCW},
  {"DrawCubeWires", l_DrawCubeWires},
  {"SetTraceLogExit", l_SetTraceLogExit},
  {"LoadFontEx", l_LoadFontEx},
  {"UnloadRenderTexture", l_UnloadRenderTexture},
  {"GetNextCodepoint", l_GetNextCodepoint},
  {"CheckCollisionCircles", l_CheckCollisionCircles},
  {"IsMouseButtonUp", l_IsMouseButtonUp},
  {"TextIsEqual", l_TextIsEqual},
  {"DrawModelEx", l_DrawModelEx},
  {"DrawTexturePro", l_DrawTexturePro},
  {"StopAudioStream", l_StopAudioStream},
  {"GetClipboardText", l_GetClipboardText},
  {"ImageText", l_ImageText},
  {"DrawRectangleRec", l_DrawRectangleRec},
  {"SetVrConfiguration", l_SetVrConfiguration},
  {"GetMusicTimePlayed", l_GetMusicTimePlayed},
  {"CloseAudioStream", l_CloseAudioStream},
  {"StorageSaveValue", l_StorageSaveValue},
  {"IsAudioStreamPlaying", l_IsAudioStreamPlaying},
  {"GenTextureBRDF", l_GenTextureBRDF},
  {"ImageFlipVertical", l_ImageFlipVertical},
  {"CheckCollisionRayBox", l_CheckCollisionRayBox},
  {"GenImageWhiteNoise", l_GenImageWhiteNoise},
  {"GetGestureDetected", l_GetGestureDetected},
  {"InitWindow", l_InitWindow},
  {"GetMouseWheelMove", l_GetMouseWheelMove},
  {"BeginMode3D", l_BeginMode3D},
  {"IsAudioBufferProcessed", l_IsAudioBufferProcessed},
  {"ColorToHSV", l_ColorToHSV},
  {"GetImageDataNormalized", l_GetImageDataNormalized},
  {"GetGamepadAxisCount", l_GetGamepadAxisCount},
  {"DrawCircle", l_DrawCircle},
  {"UnloadImage", l_UnloadImage},
  {"LoadFontData", l_LoadFontData},
  {"DrawFPS", l_DrawFPS},
  {"SetMousePosition", l_SetMousePosition},
  {"ExportWave", l_ExportWave},
  {"ColorToInt", l_ColorToInt},
  {"IsMouseButtonReleased", l_IsMouseButtonReleased},
  {"DrawCubeWiresV", l_DrawCubeWiresV},
  {"GenImageCellular", l_GenImageCellular},
  {"CheckCollisionBoxes", l_CheckCollisionBoxes},
  {"ImageTextEx", l_ImageTextEx},
  {"GetTouchY", l_GetTouchY},
  {"DrawCircleSectorLines", l_DrawCircleSectorLines},
  {"HideCursor", l_HideCursor},
  {"SetCameraMode", l_SetCameraMode},
  {"GetGestureDragVector", l_GetGestureDragVector},
  {"GenTextureIrradiance", l_GenTextureIrradiance},
  {"PauseMusicStream", l_PauseMusicStream},
  {"GetCameraMatrix", l_GetCameraMatrix},
  {"DrawLineEx", l_DrawLineEx},
  {"UnloadMaterial", l_UnloadMaterial},
  {"UnloadShader", l_UnloadShader},
  {"ImageRotateCW", l_ImageRotateCW},
  {"ExportImageAsCode", l_ExportImageAsCode},
  {"GetCollisionRayGround", l_GetCollisionRayGround},
  {"GenMeshHemiSphere", l_GenMeshHemiSphere},
  {"InitAudioStream", l_InitAudioStream},
  {"ShowCursor", l_ShowCursor},
  {"GetScreenData", l_GetScreenData},
  {"GenImageGradientRadial", l_GenImageGradientRadial},
  {"GetFontDefault", l_GetFontDefault},
  {"Fade", l_Fade},
  {"IsMusicPlaying", l_IsMusicPlaying},
  {"SetMatrixProjection", l_SetMatrixProjection},
  {"DrawCircle3D", l_DrawCircle3D},
  {"BeginMode2D", l_BeginMode2D},
  {"SetWindowPosition", l_SetWindowPosition},
  {"TextToLower", l_TextToLower},
  {"SetTraceLogCallback", l_SetTraceLogCallback},
  {"CheckCollisionRecs", l_CheckCollisionRecs},
  {"MeshBoundingBox", l_MeshBoundingBox},
  {"BeginBlendMode", l_BeginBlendMode},
  {"CheckCollisionPointTriangle", l_CheckCollisionPointTriangle},
  {"LoadModelFromMesh", l_LoadModelFromMesh},
  {"SetSoundVolume", l_SetSoundVolume},
  {"DrawSphereWires", l_DrawSphereWires},
  {"ToggleFullscreen", l_ToggleFullscreen},
  {"ImageCopy", l_ImageCopy},
  {"ExportWaveAsCode", l_ExportWaveAsCode},
  {"DrawCircleV", l_DrawCircleV},
  {"LoadRenderTexture", l_LoadRenderTexture},
  {"GetFileModTime", l_GetFileModTime},
  {"GetMusicTimeLength", l_GetMusicTimeLength},
  {"ImageAlphaPremultiply", l_ImageAlphaPremultiply},
  {"SetMouseScale", l_SetMouseScale},
  {"GetTextureDefault", l_GetTextureDefault},
  {"LoadTexture", l_LoadTexture},
  {"GenImageFontAtlas", l_GenImageFontAtlas},
  {"GetDirectoryPath", l_GetDirectoryPath},
  {"ImageAlphaClear", l_ImageAlphaClear},
  {"FileExists", l_FileExists},
  {"LoadMeshes", l_LoadMeshes},
  {"ImageResizeNN", l_ImageResizeNN},
  {"EndScissorMode", l_EndScissorMode},
  {"EndVrDrawing", l_EndVrDrawing},
  {"ExportImage", l_ExportImage},
  {"GetMouseY", l_GetMouseY},
  {"GetColor", l_GetColor},
  {"LoadFont", l_LoadFont},
  {"TextFormat", l_TextFormat},
  {"ResumeAudioStream", l_ResumeAudioStream},
  {"DrawSphere", l_DrawSphere},
  {"SetShaderValueIVec3", l_SetShaderValueIVec3},
  {"GenMeshCylinder", l_GenMeshCylinder},
  {"SetShaderValueTexture", l_SetShaderValueTexture},
  {"GetWindowHandle", l_GetWindowHandle},
  {"UnloadModelAnimation", l_UnloadModelAnimation},
  {"DrawBillboardRec", l_DrawBillboardRec},
  {"GetGamepadAxisMovement", l_GetGamepadAxisMovement},
  {"DrawCylinder", l_DrawCylinder},
  {"GenImagePerlinNoise", l_GenImagePerlinNoise},
  {"GetPixelDataSize", l_GetPixelDataSize},
  {"DrawRingLines", l_DrawRingLines},
  {"DrawRectangleRoundedLines", l_DrawRectangleRoundedLines},
  {"ColorNormalize", l_ColorNormalize},
  {"SetShaderValueFloat", l_SetShaderValueFloat},
  {"IsKeyDown", l_IsKeyDown},
  {"SetShaderValueVec3", l_SetShaderValueVec3},
  {"GetTextureData", l_GetTextureData},
  {"DrawRectanglePro", l_DrawRectanglePro},
  {"GetFPS", l_GetFPS},
  {"UpdateTexture", l_UpdateTexture},
  {"DrawLineV", l_DrawLineV},
  {"SetShaderValueInt", l_SetShaderValueInt},
  {"DrawGizmo", l_DrawGizmo},
  {"SetShaderValueSampler2D", l_SetShaderValueSampler2D},
  {"SetShaderValueVec2", l_SetShaderValueVec2},
  {"SetMasterVolume", l_SetMasterVolume},
  {"GetGestureDragAngle", l_GetGestureDragAngle},
  {"SetShaderValueIVec2", l_SetShaderValueIVec2},
  {"GetShaderLocation", l_GetShaderLocation},
  {"WindowShouldClose", l_WindowShouldClose},
  {"DrawCircleSector", l_DrawCircleSector},
  {"EndMode2D", l_EndMode2D},
  {"DrawCubeV", l_DrawCubeV},
  {"IsFileExtension", l_IsFileExtension},
  {"GetMonitorName", l_GetMonitorName},
  {"WaveFormat", l_WaveFormat},
  {"WaveCrop", l_WaveCrop},
  {"IsWindowReady", l_IsWindowReady},
  {"WaveCopy", l_WaveCopy},
  {"GenMeshPoly", l_GenMeshPoly},
  {"ImageDrawTextEx", l_ImageDrawTextEx},
  {"UpdateVrTracking", l_UpdateVrTracking},
  {"SetAudioStreamPitch", l_SetAudioStreamPitch},
  {"DrawSphereEx", l_DrawSphereEx},
  {"UpdateSound", l_UpdateSound},
  {"EnableCursor", l_EnableCursor},
  {"ImageToPOT", l_ImageToPOT},
  {"GenMeshCube", l_GenMeshCube},
  {"UpdateMusicStream", l_UpdateMusicStream},
  {"UpdateModelAnimation", l_UpdateModelAnimation},
  {"IsKeyUp", l_IsKeyUp},
  {"IsKeyReleased", l_IsKeyReleased},
  {"GenImageChecked", l_GenImageChecked},
  {"GenMeshTorus", l_GenMeshTorus},
  {"UpdateCamera", l_UpdateCamera},
  {"UpdateAudioStream", l_UpdateAudioStream},
  {"UnloadWave", l_UnloadWave},
  {"SetShaderValueIVec4", l_SetShaderValueIVec4},
  {"UnloadSound", l_UnloadSound},
  {"SetTraceLogLevel", l_SetTraceLogLevel},
  {"IsVrSimulatorReady", l_IsVrSimulatorReady},
  {"CheckCollisionPointRec", l_CheckCollisionPointRec},
  {"ColorFromHSV", l_ColorFromHSV},
  {"ImageDither", l_ImageDither},
  {"DrawTriangleFan", l_DrawTriangleFan},
  {"GenImageGradientV", l_GenImageGradientV},
  {"SetWindowIcon", l_SetWindowIcon},
  {"TextReplace", l_TextReplace},
  {"TraceLog", l_TraceLog},
  {"StorageLoadValue", l_StorageLoadValue},
  {"IsGamepadButtonUp", l_IsGamepadButtonUp},
  {"GetMouseX", l_GetMouseX},
  {"GetMonitorCount", l_GetMonitorCount},
  {"TextToPascal", l_TextToPascal},
  {"GenTexturePrefilter", l_GenTexturePrefilter},
  {"GetFileName", l_GetFileName},
  {"ResumeSound", l_ResumeSound},
  {"TextToInteger", l_TextToInteger},
  {"TextSubtext", l_TextSubtext},
  {"DrawRectangleLinesEx", l_DrawRectangleLinesEx},
  {"ImageFormat", l_ImageFormat},
  {"IsSoundPlaying", l_IsSoundPlaying},
  {"UnhideWindow", l_UnhideWindow},
  {"DrawRectangleGradientEx", l_DrawRectangleGradientEx},
  {"TextLength", l_TextLength},
  {"CheckCollisionCircleRec", l_CheckCollisionCircleRec},
  {"TextJoin", l_TextJoin},
  {"TextInsert", l_TextInsert},
  {"ChangeDirectory", l_ChangeDirectory},
  {"GetCollisionRec", l_GetCollisionRec},
  {"TextCountCodepoints", l_TextCountCodepoints},
  {"TextAppend", l_TextAppend},
  {"IsWindowHidden", l_IsWindowHidden},
  {"ImageDrawRectangleLines", l_ImageDrawRectangleLines},
  {"StopSound", l_StopSound},
  {"LoadText", l_LoadText},
  {"StopMusicStream", l_StopMusicStream},
  {"SetWindowTitle", l_SetWindowTitle},
  {"IsGestureDetected", l_IsGestureDetected},
  {"SetWindowSize", l_SetWindowSize},
  {"ClearDirectoryFiles", l_ClearDirectoryFiles},
  {"DrawModelWires", l_DrawModelWires},
  {"SetWindowMonitor", l_SetWindowMonitor},
  {"SetWindowMinSize", l_SetWindowMinSize},
  {"EndShaderMode", l_EndShaderMode},
  {"UnloadFont", l_UnloadFont},
  ...
  {"LoadImageRaw", l_LoadImageRaw},
  {"SetTargetFPS", l_SetTargetFPS},
  {"GenTextureMipmaps", l_GenTextureMipmaps},
  {"DrawLineBezier", l_DrawLineBezier},
  {"GetCollisionRayTriangle", l_GetCollisionRayTriangle},
  {"MeasureText", l_MeasureText},
  {"DrawPixelV", l_DrawPixelV},
  {"InitVrSimulator", l_InitVrSimulator},
  {"GetGestureHoldDuration", l_GetGestureHoldDuration},
  {"PlayMusicStream", l_PlayMusicStream},
  {"SetShapesTexture", l_SetShapesTexture},
  ...
  {"SetGesturesEnabled", l_SetGesturesEnabled},
  {"DrawRectangleLines", l_DrawRectangleLines},
  {"DrawTextureNPatch", l_DrawTextureNPatch},
  {"MeshBinormals", l_MeshBinormals},
  {"SetMusicVolume", l_SetMusicVolume},
  {"DrawPoly", l_DrawPoly},
  {"LoadModelAnimations", l_LoadModelAnimations},
  {"LoadWaveEx", l_LoadWaveEx},
  {"SetMusicPitch", l_SetMusicPitch},
  {"DrawModel", l_DrawModel},
  {"GenTextureCubemap", l_GenTextureCubemap},
  {"SetMusicLoopCount", l_SetMusicLoopCount},
  {"SetMouseOffset", l_SetMouseOffset},
  {"SetModelMeshMaterial", l_SetModelMeshMaterial},
  {"SetMatrixModelview", l_SetMatrixModelview},
  {"DrawTextRecEx", l_DrawTextRecEx},
  {"DrawBoundingBox", l_DrawBoundingBox},
  {"UnloadTexture", l_UnloadTexture},
  {"SetExitKey", l_SetExitKey},
  {"SetClipboardText", l_SetClipboardText},
  {"DrawRay", l_DrawRay},
  {"MeasureTextEx", l_MeasureTextEx},
  {"SetCameraSmoothZoomControl", l_SetCameraSmoothZoomControl},
  {"DrawTriangleLines", l_DrawTriangleLines},
  {"SetCameraPanControl", l_SetCameraPanControl},
  {"IsKeyPressed", l_IsKeyPressed},
  {"BeginShaderMode", l_BeginShaderMode},
  {"SetCameraAltControl", l_SetCameraAltControl},
  {"MeshTangents", l_MeshTangents},
  {"ResumeMusicStream", l_ResumeMusicStream},
  {"EndTextureMode", l_EndTextureMode},
  {"PlayAudioStream", l_PlayAudioStream},
  {"CheckCollisionBoxSphere", l_CheckCollisionBoxSphere},
  {"ImageDraw", l_ImageDraw},
  {"ImageDrawText", l_ImageDrawText},
  {"PauseAudioStream", l_PauseAudioStream},
  {"DrawTextureEx", l_DrawTextureEx},
  {"BeginTextureMode", l_BeginTextureMode},
  {"IsMouseButtonDown", l_IsMouseButtonDown},
  {"OpenURL", l_OpenURL},
  {"SetAudioStreamVolume", l_SetAudioStreamVolume},
  {"GenMeshSphere", l_GenMeshSphere},
  {"GenImageColor", l_GenImageColor},
  {"GetWorkingDirectory", l_GetWorkingDirectory},
  {"SetSoundPitch", l_SetSoundPitch},
  {"LoadWave", l_LoadWave},
  {"LoadImageEx", l_LoadImageEx},
  {"GetFrameTime", l_GetFrameTime},
  {"LoadTextureFromImage", l_LoadTextureFromImage},
  {"LoadTextureCubemap", l_LoadTextureCubemap},
  {"GetGesturePinchVector", l_GetGesturePinchVector},
  {"LoadSound", l_LoadSound},
  {"LoadShaderCode", l_LoadShaderCode},
  {"LoadShader", l_LoadShader},
  {"DrawLineStrip", l_DrawLineStrip},
  {"DrawCircleLines", l_DrawCircleLines},
  {"GetGesturePinchAngle", l_GetGesturePinchAngle},
  {"GetDirectoryFiles", l_GetDirectoryFiles},
  {"LoadMusicStream", l_LoadMusicStream},
  {"SetShaderValueV", l_SetShaderValueV},
  {"LoadMaterials", l_LoadMaterials},
  {"DrawBillboard", l_DrawBillboard},
  {"LoadMaterialDefault", l_LoadMaterialDefault},
  {"DrawRectangleGradientH", l_DrawRectangleGradientH},
  {"GetMatrixModelview", l_GetMatrixModelview},
  {"ClearBackground", l_ClearBackground},
  {"LoadImage", l_LoadImage},
  {"LoadFontFromImage", l_LoadFontFromImage},
  {"DrawText", l_DrawText},
  {"IsWindowResized", l_IsWindowResized},
  {"DrawCircleGradient", l_DrawCircleGradient},
  {"IsWindowMinimized", l_IsWindowMinimized},
  {"ExportMesh", l_ExportMesh},
  {"UnloadModel", l_UnloadModel},
  {"GetMonitorPhysicalWidth", l_GetMonitorPhysicalWidth},
  {"TextSplit", l_TextSplit},
  {"DrawRing", l_DrawRing},
  {"IsMouseButtonPressed", l_IsMouseButtonPressed},
  {"DrawTexture", l_DrawTexture},
  {"IsModelAnimationValid", l_IsModelAnimationValid},
  {"SetCameraMoveControls", l_SetCameraMoveControls},
  {"IsGamepadButtonReleased", l_IsGamepadButtonReleased},
  {"BeginVrDrawing", l_BeginVrDrawing},
  {"TextToUpper", l_TextToUpper},
  {"GetMousePosition", l_GetMousePosition},
  {"CheckCollisionRaySphereEx", l_CheckCollisionRaySphereEx},
  {"IsGamepadName", l_IsGamepadName},
  {"IsGamepadButtonPressed", l_IsGamepadButtonPressed},
  {"DrawRectangleV", l_DrawRectangleV},
  {"GetShaderDefault", l_GetShaderDefault},
  {"ImageColorGrayscale", l_ImageColorGrayscale},
  {"SetTextureWrap", l_SetTextureWrap},
  {"GetGamepadButtonPressed", l_GetGamepadButtonPressed},
  {"BeginScissorMode", l_BeginScissorMode},
  {"DrawCylinderWires", l_DrawCylinderWires},
  {"GetImageData", l_GetImageData},
  {"IsFileDropped", l_IsFileDropped},
  {"IsCursorHidden", l_IsCursorHidden},
  {"GetMonitorWidth", l_GetMonitorWidth},
  {"CheckCollisionPointCircle", l_CheckCollisionPointCircle},
  {"InitAudioDevice", l_InitAudioDevice},
  {"TextFindIndex", l_TextFindIndex},
  {"GenMeshHeightmap", l_GenMeshHeightmap},
  {"ImageResize", l_ImageResize},
  {"ImageMipmaps", l_ImageMipmaps},
  {"LoadImagePro", l_LoadImagePro},
  {"IsAudioDeviceReady", l_IsAudioDeviceReady},
  {"TakeScreenshot", l_TakeScreenshot},
  {"DrawTextureQuad", l_DrawTextureQuad},
  {"DrawCubeTexture", l_DrawCubeTexture},
  {"HideWindow", l_HideWindow},
  {"BeginDrawing", l_BeginDrawing},
  {"GenMeshPlane", l_GenMeshPlane},
  {"GetTouchX", l_GetTouchX},
  {"PauseSound", l_PauseSound},
  {"EndDrawing", l_EndDrawing},
  {"UnloadMesh", l_UnloadMesh},
  {"ImageCrop", l_ImageCrop},
  {"ClearDroppedFiles", l_ClearDroppedFiles},
  {"DrawTextureV", l_DrawTextureV},
  {"DrawRectangleRounded", l_DrawRectangleRounded},
  {"ImageColorInvert", l_ImageColorInvert},
  {"ImageColorContrast", l_ImageColorContrast},
  {"ImageColorBrightness", l_ImageColorBrightness},
  {"ImageAlphaMask", l_ImageAlphaMask},
  {"GetGlyphIndex", l_GetGlyphIndex},
  {"GetRandomValue", l_GetRandomValue},
  {"GetMonitorPhysicalHeight", l_GetMonitorPhysicalHeight},
  {"DisableCursor", l_DisableCursor},
  {"GetWaveData", l_GetWaveData},
  {"GetTouchPointsCount", l_GetTouchPointsCount},
  {"DrawTextEx", l_DrawTextEx},
  {"GetTime", l_GetTime},
  {"DrawModelWiresEx", l_DrawModelWiresEx},
  {"GetScreenHeight", l_GetScreenHeight},
  {"IsGamepadButtonDown", l_IsGamepadButtonDown},
  {"GetScreenWidth", l_GetScreenWidth},
  {"DrawLine", l_DrawLine},
  {"GetMouseRay", l_GetMouseRay},
  {"CloseAudioDevice", l_CloseAudioDevice},
  {"ImageExtractPalette", l_ImageExtractPalette},
  {"GetWorldToScreen", l_GetWorldToScreen},
  {"GetMonitorHeight", l_GetMonitorHeight},
  {"GetKeyPressed", l_GetKeyPressed},
  {"ImageAlphaCrop", l_ImageAlphaCrop},
  {"LoadSoundFromWave", l_LoadSoundFromWave},
  {"GetCollisionRayModel", l_GetCollisionRayModel},
  {"GetGamepadName", l_GetGamepadName},
  {"DrawTextRec", l_DrawTextRec},
  {"GetFileNameWithoutExt", l_GetFileNameWithoutExt},
  {"CloseWindow", l_CloseWindow},
  {"CheckCollisionRaySphere", l_CheckCollisionRaySphere},
  {"SetShaderValueVec4", l_SetShaderValueVec4},
  {"GetExtension", l_GetExtension},
  {"ImageDrawRectangle", l_ImageDrawRectangle},
  {"GenMeshCubicmap", l_GenMeshCubicmap},
  {"GenMeshKnot", l_GenMeshKnot},
  ...
  {"ImageColorReplace", l_ImageColorReplace},
  {"DrawTextureRec", l_DrawTextureRec},
  {"SetMaterialTexture", l_SetMaterialTexture},
  {"CheckCollisionSpheres", l_CheckCollisionSpheres},
  {"ImageFlipHorizontal", l_ImageFlipHorizontal},
  {"DrawLine3D", l_DrawLine3D},
  {"DrawPixel", l_DrawPixel},
  {"DrawGrid", l_DrawGrid},
  {"DrawCube", l_DrawCube},
  {"ImageResizeCanvas", l_ImageResizeCanvas},
  {"ImageColorTintU", l_ImageColorTintU},
  {"DrawCubeWiresU", l_DrawCubeWiresU},
  {"CheckCollisionCirclesU", l_CheckCollisionCirclesU},
  {"DrawModelExU", l_DrawModelExU},
  {"DrawTextureProU", l_DrawTextureProU},
  {"ImageTextU", l_ImageTextU},
  {"DrawRectangleRecU", l_DrawRectangleRecU},
  {"GenTextureBRDFU", l_GenTextureBRDFU},
  {"ColorToHSVU", l_ColorToHSVU},
  {"DrawCircleU", l_DrawCircleU},
  {"ColorToIntU", l_ColorToIntU},
  {"DrawCubeWiresVU", l_DrawCubeWiresVU},
  {"ImageTextExU", l_ImageTextExU},
  {"DrawCircleSectorLinesU", l_DrawCircleSectorLinesU},
  {"GetGestureDragVectorU", l_GetGestureDragVectorU},
  {"GenTextureIrradianceU", l_GenTextureIrradianceU},
  {"GetCameraMatrixU", l_GetCameraMatrixU},
  {"DrawLineExU", l_DrawLineExU},
  {"GenImageGradientRadialU", l_GenImageGradientRadialU},
  {"FadeU", l_FadeU},
  {"SetMatrixProjectionU", l_SetMatrixProjectionU},
  {"DrawCircle3DU", l_DrawCircle3DU},
  {"CheckCollisionRecsU", l_CheckCollisionRecsU},
  {"CheckCollisionPointTriangleU", l_CheckCollisionPointTriangleU},
  {"DrawSphereWiresU", l_DrawSphereWiresU},
  {"DrawCircleVU", l_DrawCircleVU},
  {"GetTextureDefaultU", l_GetTextureDefaultU},
  {"LoadTextureU", l_LoadTextureU},
  {"ImageAlphaClearU", l_ImageAlphaClearU},
  {"GetColorU", l_GetColorU},
  {"DrawSphereU", l_DrawSphereU},
  {"SetShaderValueIVec3U", l_SetShaderValueIVec3U},
  {"SetShaderValueTextureU", l_SetShaderValueTextureU},
  {"DrawBillboardRecU", l_DrawBillboardRecU},
  {"DrawCylinderU", l_DrawCylinderU},
  {"DrawRingLinesU", l_DrawRingLinesU},
  {"DrawRectangleRoundedLinesU", l_DrawRectangleRoundedLinesU},
  {"ColorNormalizeU", l_ColorNormalizeU},
  {"SetShaderValueVec3U", l_SetShaderValueVec3U},
  {"GetTextureDataU", l_GetTextureDataU},
  {"DrawRectangleProU", l_DrawRectangleProU},
  {"UpdateTextureU", l_UpdateTextureU},
  {"DrawLineVU", l_DrawLineVU},
  {"DrawGizmoU", l_DrawGizmoU},
  {"SetShaderValueVec2U", l_SetShaderValueVec2U},
  {"SetShaderValueIVec2U", l_SetShaderValueIVec2U},
  {"DrawCircleSectorU", l_DrawCircleSectorU},
  {"DrawCubeVU", l_DrawCubeVU},
  {"ImageDrawTextExU", l_ImageDrawTextExU},
  {"DrawSphereExU", l_DrawSphereExU},
  {"ImageToPOTU", l_ImageToPOTU},
  {"GenImageCheckedU", l_GenImageCheckedU},
  {"SetShaderValueIVec4U", l_SetShaderValueIVec4U},
  {"CheckCollisionPointRecU", l_CheckCollisionPointRecU},
  {"ColorFromHSVU", l_ColorFromHSVU},
  {"GenImageGradientVU", l_GenImageGradientVU},
  {"GenTexturePrefilterU", l_GenTexturePrefilterU},
  {"DrawRectangleLinesExU", l_DrawRectangleLinesExU},
  {"DrawRectangleGradientExU", l_DrawRectangleGradientExU},
  {"CheckCollisionCircleRecU", l_CheckCollisionCircleRecU},
  {"GetCollisionRecU", l_GetCollisionRecU},
  {"ImageDrawRectangleLinesU", l_ImageDrawRectangleLinesU},
  {"DrawModelWiresU", l_DrawModelWiresU},
  {"DrawTriangleU", l_DrawTriangleU},
  {"SetTextureFilterU", l_SetTextureFilterU},
  {"DrawLineBezierU", l_DrawLineBezierU},
  {"GetCollisionRayTriangleU", l_GetCollisionRayTriangleU},
  {"DrawPixelVU", l_DrawPixelVU},
  {"SetShapesTextureU", l_SetShapesTextureU},
  {"GetTouchPositionU", l_GetTouchPositionU},
  {"SetShaderValueMatrixU", l_SetShaderValueMatrixU},
  {"DrawRectangleU", l_DrawRectangleU},
  {"DrawRectangleLinesU", l_DrawRectangleLinesU},
  {"DrawTextureNPatchU", l_DrawTextureNPatchU},
  {"DrawPolyU", l_DrawPolyU},
  {"DrawModelU", l_DrawModelU},
  {"GenTextureCubemapU", l_GenTextureCubemapU},
  {"SetMatrixModelviewU", l_SetMatrixModelviewU},
  {"DrawTextRecExU", l_DrawTextRecExU},
  {"DrawBoundingBoxU", l_DrawBoundingBoxU},
  {"UnloadTextureU", l_UnloadTextureU},
  {"DrawRayU", l_DrawRayU},
  {"MeasureTextExU", l_MeasureTextExU},
  {"DrawTriangleLinesU", l_DrawTriangleLinesU},
  {"CheckCollisionBoxSphereU", l_CheckCollisionBoxSphereU},
  {"ImageDrawU", l_ImageDrawU},
  {"ImageDrawTextU", l_ImageDrawTextU},
  {"DrawTextureExU", l_DrawTextureExU},
  {"GenImageColorU", l_GenImageColorU},
  {"LoadTextureFromImageU", l_LoadTextureFromImageU},
  {"LoadTextureCubemapU", l_LoadTextureCubemapU},
  {"GetGesturePinchVectorU", l_GetGesturePinchVectorU},
  {"DrawCircleLinesU", l_DrawCircleLinesU},
  {"DrawBillboardU", l_DrawBillboardU},
  {"DrawRectangleGradientHU", l_DrawRectangleGradientHU},
  {"GetMatrixModelviewU", l_GetMatrixModelviewU},
  {"ClearBackgroundU", l_ClearBackgroundU},
  {"LoadFontFromImageU", l_LoadFontFromImageU},
  {"DrawTextU", l_DrawTextU},
  {"DrawCircleGradientU", l_DrawCircleGradientU},
  {"DrawRingU", l_DrawRingU},
  {"DrawTextureU", l_DrawTextureU},
  {"GetMousePositionU", l_GetMousePositionU},
  {"DrawRectangleVU", l_DrawRectangleVU},
  {"SetTextureWrapU", l_SetTextureWrapU},
  {"DrawCylinderWiresU", l_DrawCylinderWiresU},
  {"CheckCollisionPointCircleU", l_CheckCollisionPointCircleU},
  {"GenMeshHeightmapU", l_GenMeshHeightmapU},
  {"DrawTextureQuadU", l_DrawTextureQuadU},
  {"DrawCubeTextureU", l_DrawCubeTextureU},
  {"ImageCropU", l_ImageCropU},
  {"DrawTextureVU", l_DrawTextureVU},
  {"DrawRectangleRoundedU", l_DrawRectangleRoundedU},
  {"DrawTextExU", l_DrawTextExU},
  {"DrawModelWiresExU", l_DrawModelWiresExU},
  {"DrawLineU", l_DrawLineU},
  {"GetMouseRayU", l_GetMouseRayU},
  {"GetWorldToScreenU", l_GetWorldToScreenU},
  {"DrawTextRecU", l_DrawTextRecU},
  {"CheckCollisionRaySphereU", l_CheckCollisionRaySphereU},
  {"SetShaderValueVec4U", l_SetShaderValueVec4U},
  {"ImageDrawRectangleU", l_ImageDrawRectangleU},
  {"GenMeshCubicmapU", l_GenMeshCubicmapU},
  {"DrawPlaneU", l_DrawPlaneU},
  {"DrawRectangleGradientVU", l_DrawRectangleGradientVU},
  {"GenImageGradientHU", l_GenImageGradientHU},
  {"ImageColorReplaceU", l_ImageColorReplaceU},
  {"DrawTextureRecU", l_DrawTextureRecU},
  {"SetMaterialTextureU", l_SetMaterialTextureU},
  {"CheckCollisionSpheresU", l_CheckCollisionSpheresU},
  {"DrawLine3DU", l_DrawLine3DU},
  {"DrawPixelU", l_DrawPixelU},
  {"DrawCubeU", l_DrawCubeU},
  {"ImageResizeCanvasU", l_ImageResizeCanvasU},
  {"IVector3", l_IVector3_new},
  {"IVector3Meta", l_IVector3_meta},
  {"Image", l_Image_new},
  {"ImageMeta", l_Image_meta},
  {"Wave", l_Wave_new},
  {"WaveMeta", l_Wave_meta},
  {"CharInfo", l_CharInfo_new},
  {"CharInfoMeta", l_CharInfo_meta},
  {"IVector2", l_IVector2_new},
  {"IVector2Meta", l_IVector2_meta},
  {"IVector4", l_IVector4_new},
  {"IVector4Meta", l_IVector4_meta},
  {"VrDeviceInfo", l_VrDeviceInfo_new},
  {"VrDeviceInfoMeta", l_VrDeviceInfo_meta},
  {"NPatchInfo", l_NPatchInfo_new},
  {"NPatchInfoMeta", l_NPatchInfo_meta},
  {"Material", l_Material_new},
  {"MaterialMeta", l_Material_meta},
  {"Vector2", l_Vector2_new},
  {"Vector2Meta", l_Vector2_meta},
  {"Rectangle", l_Rectangle_new},
  {"RectangleMeta", l_Rectangle_meta},
  {"BoundingBox", l_BoundingBox_new},
  {"BoundingBoxMeta", l_BoundingBox_meta},
  {"Camera2D", l_Camera2D_new},
  {"Camera2DMeta", l_Camera2D_meta},
  {"Vector3", l_Vector3_new},
  {"Vector3Meta", l_Vector3_meta},
  {"Camera3D", l_Camera3D_new},
  {"Camera3DMeta", l_Camera3D_meta},
  {"Mesh", l_Mesh_new},
  {"MeshMeta", l_Mesh_meta},
  {"AudioStream", l_AudioStream_new},
  {"AudioStreamMeta", l_AudioStream_meta},
  {"Texture2D", l_Texture2D_new},
  {"Texture2DMeta", l_Texture2D_meta},
  {"Font", l_Font_new},
  {"FontMeta", l_Font_meta},
  {"Sound", l_Sound_new},
  {"SoundMeta", l_Sound_meta},
  {"BoneInfo", l_BoneInfo_new},
  {"BoneInfoMeta", l_BoneInfo_meta},
  {"MaterialMap", l_MaterialMap_new},
  {"MaterialMapMeta", l_MaterialMap_meta},
  {"RenderTexture2D", l_RenderTexture2D_new},
  {"RenderTexture2DMeta", l_RenderTexture2D_meta},
  {"RayHitInfo", l_RayHitInfo_new},
  {"RayHitInfoMeta", l_RayHitInfo_meta},
  {"Vector4", l_Vector4_new},
  {"Vector4Meta", l_Vector4_meta},
  {"Model", l_Model_new},
  {"ModelMeta", l_Model_meta},
  {"Shader", l_Shader_new},
  {"ShaderMeta", l_Shader_meta},
  {"ModelAnimation", l_ModelAnimation_new},
  {"ModelAnimationMeta", l_ModelAnimation_meta},
  {"Matrix", l_Matrix_new},
  {"MatrixMeta", l_Matrix_meta},
  {"Color", l_Color_new},
  {"ColorMeta", l_Color_meta},
  {"Transform", l_Transform_new},
  {"TransformMeta", l_Transform_meta},
  {"Ray", l_Ray_new},
  {"RayMeta", l_Ray_meta},
  {NULL, NULL}
};

static int l_IVector3__eq(lua_State *L) {
...
static int l_IVector3_unpack(lua_State *L) {
...
static int l_IVector3_set_x(lua_State *L) {
...
static int l_IVector3_get_x(lua_State *L) {
  IVector3* obj = luaL_checkudata(L, 1, "IVector3");
  int result = obj->x;
  lua_pushinteger(L, result);
  return 1;
...
static int l_IVector3_set_y(lua_State *L) {
  IVector3* obj = luaL_checkudata(L, 1, "IVector3");
  int y = luaL_checkinteger(L, 2);
  obj->y = y;
  lua_pop(L, 1);
...
static int l_IVector3_get_y(lua_State *L) {
  IVector3* obj = luaL_checkudata(L, 1, "IVector3");
  int result = obj->y;
  lua_pushinteger(L, result);
  return 1;
...
static int l_IVector3_set_z(lua_State *L) {
  IVector3* obj = luaL_checkudata(L, 1, "IVector3");
...
static int l_IVector3_get_z(lua_State *L) {
  IVector3* obj = luaL_checkudata(L, 1, "IVector3");
  int result = obj->z;
  lua_pushinteger(L, result);
  return 1;
...
static const luaL_Reg l_IVector3[] = {
  {"getX", l_IVector3_get_x},
  {"setX", l_IVector3_set_x},
  {"getY", l_IVector3_get_y},
  {"setY", l_IVector3_set_y},
  {"getZ", l_IVector3_get_z},
  {"setZ", l_IVector3_set_z},
  {"__eq", l_IVector3__eq},
  {"unpack", l_IVector3_unpack},
  {NULL, NULL}
};

static void l_IVector3_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "IVector3");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_IVector3, 0);
  lua_pop(L, 1);
}
...
static int l_Image_get_data(lua_State *L) {
  Image* obj = luaL_checkudata(L, 1, "Image");
...
static int l_Image_set_width(lua_State *L) {
  Image* obj = luaL_checkudata(L, 1, "Image");
  int width = luaL_checkinteger(L, 2);
  obj->width = width;
  lua_pop(L, 1);
...
static int l_Image_set_height(lua_State *L) {
  Image* obj = luaL_checkudata(L, 1, "Image");
  int height = luaL_checkinteger(L, 2);
  obj->height = height;
  lua_pop(L, 1);
...
static int l_Image_set_mipmaps(lua_State *L) {
  Image* obj = luaL_checkudata(L, 1, "Image");
...
static int l_Image_get_mipmaps(lua_State *L) {
  Image* obj = luaL_checkudata(L, 1, "Image");
...
static int l_Image_set_format(lua_State *L) {
  Image* obj = luaL_checkudata(L, 1, "Image");
...
static int l_Image_get_format(lua_State *L) {
  Image* obj = luaL_checkudata(L, 1, "Image");
...
static const luaL_Reg l_Image[] = {
  {"getData", l_Image_get_data},
  {"setData", l_Image_set_data},
  {"getWidth", l_Image_get_width},
  {"setWidth", l_Image_set_width},
  {"getHeight", l_Image_get_height},
  {"setHeight", l_Image_set_height},
  {"getMipmaps", l_Image_get_mipmaps},
  {"setMipmaps", l_Image_set_mipmaps},
  {"getFormat", l_Image_get_format},
  {"setFormat", l_Image_set_format},
  {NULL, NULL}
};

static void l_Image_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "Image");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_Image, 0);
  lua_pop(L, 1);
}

static int l_Wave_set_sampleCount(lua_State *L) {
...
static int l_Wave_get_sampleCount(lua_State *L) {
  Wave* obj = luaL_checkudata(L, 1, "Wave");
...
static int l_Wave_set_sampleRate(lua_State *L) {
  Wave* obj = luaL_checkudata(L, 1, "Wave");
...
static int l_Wave_get_sampleRate(lua_State *L) {
  Wave* obj = luaL_checkudata(L, 1, "Wave");
...
static int l_Wave_set_sampleSize(lua_State *L) {
  Wave* obj = luaL_checkudata(L, 1, "Wave");
  unsigned int sampleSize = luaL_checkinteger(L, 2);
...
static int l_Wave_get_sampleSize(lua_State *L) {
  Wave* obj = luaL_checkudata(L, 1, "Wave");
...
static int l_Wave_set_channels(lua_State *L) {
  Wave* obj = luaL_checkudata(L, 1, "Wave");
...
static int l_Wave_get_channels(lua_State *L) {
  Wave* obj = luaL_checkudata(L, 1, "Wave");
...
static int l_Wave_set_data(lua_State *L) {
  Wave* obj = luaL_checkudata(L, 1, "Wave");
  void* data = luaX_checklightuserdata(L, 2, "?");
  obj->data = data;
  lua_pop(L, 1);
...
static int l_Wave_get_data(lua_State *L) {
  Wave* obj = luaL_checkudata(L, 1, "Wave");
  void* result = obj->data;
  if (result == NULL) lua_pushnil(L); else lua_pushlightuserdata(L, result);
  return 1;
...
static const luaL_Reg l_Wave[] = {
  {"getSampleCount", l_Wave_get_sampleCount},
  {"setSampleCount", l_Wave_set_sampleCount},
  {"getSampleRate", l_Wave_get_sampleRate},
  {"setSampleRate", l_Wave_set_sampleRate},
  {"getSampleSize", l_Wave_get_sampleSize},
  {"setSampleSize", l_Wave_set_sampleSize},
  {"getChannels", l_Wave_get_channels},
  {"setChannels", l_Wave_set_channels},
  {"getData", l_Wave_get_data},
  {"setData", l_Wave_set_data},
  {NULL, NULL}
};

static void l_Wave_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "Wave");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_Wave, 0);
  lua_pop(L, 1);
}

static int l_CharInfo_set_value(lua_State *L) {
...
static int l_CharInfo_get_value(lua_State *L) {
  CharInfo* obj = luaL_checkudata(L, 1, "CharInfo");
...
static int l_CharInfo_set_rec(lua_State *L) {
  CharInfo* obj = luaL_checkudata(L, 1, "CharInfo");
  Rectangle rec = (*(Rectangle*)luaL_checkudata(L, 2, "Rectangle"));
  obj->rec = rec;
  lua_pop(L, 1);
...
static int l_CharInfo_get_rec(lua_State *L) {
  CharInfo* obj = luaL_checkudata(L, 1, "CharInfo");
...
static int l_CharInfo_set_recU(lua_State *L) {
  CharInfo* obj = luaL_checkudata(L, 1, "CharInfo");
  Rectangle rec = {luaL_checknumber(L, 2), luaL_checknumber(L, 3), luaL_checknumber(L, 4), luaL_checknumber(L, 5)};
  obj->rec = rec;
  lua_pop(L, 4);
...
static int l_CharInfo_get_recU(lua_State *L) {
  CharInfo* obj = luaL_checkudata(L, 1, "CharInfo");
  Rectangle result = obj->rec;
  lua_pushnumber(L, result.x);lua_pushnumber(L, result.y);lua_pushnumber(L, result.width);lua_pushnumber(L, result.height);
  return 4;
...
static int l_CharInfo_set_offsetX(lua_State *L) {
  CharInfo* obj = luaL_checkudata(L, 1, "CharInfo");
...
static int l_CharInfo_get_offsetX(lua_State *L) {
  CharInfo* obj = luaL_checkudata(L, 1, "CharInfo");
...
static int l_CharInfo_set_offsetY(lua_State *L) {
  CharInfo* obj = luaL_checkudata(L, 1, "CharInfo");
  int offsetY = luaL_checkinteger(L, 2);
  obj->offsetY = offsetY;
  lua_pop(L, 1);
...
static int l_CharInfo_get_offsetY(lua_State *L) {
  CharInfo* obj = luaL_checkudata(L, 1, "CharInfo");
...
static int l_CharInfo_set_advanceX(lua_State *L) {
  CharInfo* obj = luaL_checkudata(L, 1, "CharInfo");
...
static int l_CharInfo_get_advanceX(lua_State *L) {
  CharInfo* obj = luaL_checkudata(L, 1, "CharInfo");
...
static int l_CharInfo_set_dataAt(lua_State *L) {
  CharInfo* obj = luaL_checkudata(L, 1, "CharInfo");
...
static int l_CharInfo_get_dataAt(lua_State *L) {
  CharInfo* obj = luaL_checkudata(L, 1, "CharInfo");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static const luaL_Reg l_CharInfo[] = {
  {"getValue", l_CharInfo_get_value},
  {"setValue", l_CharInfo_set_value},
  {"getRec", l_CharInfo_get_rec},
  {"setRec", l_CharInfo_set_rec},
  {"getRecU", l_CharInfo_get_recU},
  {"setRecU", l_CharInfo_set_recU},
  {"getOffsetX", l_CharInfo_get_offsetX},
  {"setOffsetX", l_CharInfo_set_offsetX},
  {"getOffsetY", l_CharInfo_get_offsetY},
  {"setOffsetY", l_CharInfo_set_offsetY},
  {"getAdvanceX", l_CharInfo_get_advanceX},
  {"setAdvanceX", l_CharInfo_set_advanceX},
  {"getDataAt", l_CharInfo_get_dataAt},
  {"setDataAt", l_CharInfo_set_dataAt},
  {NULL, NULL}
};

static void l_CharInfo_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "CharInfo");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_CharInfo, 0);
  lua_pop(L, 1);
}

static int l_IVector2__eq(lua_State *L) {
  lua_getmetatable(L, 1); lua_getmetatable(L, 2);
  if (lua_rawequal(L, -1, -2) == 0) {
    lua_pushboolean(L, 0);
  } else {
...
static int l_IVector2_unpack(lua_State *L) {
...
static int l_IVector2_set_x(lua_State *L) {
...
static int l_IVector2_get_x(lua_State *L) {
  IVector2* obj = luaL_checkudata(L, 1, "IVector2");
  int result = obj->x;
  lua_pushinteger(L, result);
  return 1;
...
static int l_IVector2_set_y(lua_State *L) {
  IVector2* obj = luaL_checkudata(L, 1, "IVector2");
  int y = luaL_checkinteger(L, 2);
  obj->y = y;
  lua_pop(L, 1);
...
static int l_IVector2_get_y(lua_State *L) {
  IVector2* obj = luaL_checkudata(L, 1, "IVector2");
  int result = obj->y;
  lua_pushinteger(L, result);
  return 1;
...
static const luaL_Reg l_IVector2[] = {
  {"getX", l_IVector2_get_x},
  {"setX", l_IVector2_set_x},
  {"getY", l_IVector2_get_y},
  {"setY", l_IVector2_set_y},
  {"__eq", l_IVector2__eq},
  {"unpack", l_IVector2_unpack},
  {NULL, NULL}
};

static void l_IVector2_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "IVector2");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_IVector2, 0);
  lua_pop(L, 1);
}

static int l_IVector4__eq(lua_State *L) {
  lua_getmetatable(L, 1); lua_getmetatable(L, 2);
  if (lua_rawequal(L, -1, -2) == 0) {
    lua_pushboolean(L, 0);
  } else {
...
static int l_IVector4_unpack(lua_State *L) {
...
static int l_IVector4_set_x(lua_State *L) {
...
static int l_IVector4_get_x(lua_State *L) {
  IVector4* obj = luaL_checkudata(L, 1, "IVector4");
  int result = obj->x;
  lua_pushinteger(L, result);
  return 1;
...
static int l_IVector4_set_y(lua_State *L) {
  IVector4* obj = luaL_checkudata(L, 1, "IVector4");
  int y = luaL_checkinteger(L, 2);
  obj->y = y;
  lua_pop(L, 1);
...
static int l_IVector4_get_y(lua_State *L) {
  IVector4* obj = luaL_checkudata(L, 1, "IVector4");
  int result = obj->y;
  lua_pushinteger(L, result);
  return 1;
...
static int l_IVector4_set_z(lua_State *L) {
  IVector4* obj = luaL_checkudata(L, 1, "IVector4");
  int z = luaL_checkinteger(L, 2);
  obj->z = z;
  lua_pop(L, 1);
...
static int l_IVector4_get_z(lua_State *L) {
  IVector4* obj = luaL_checkudata(L, 1, "IVector4");
  int result = obj->z;
  lua_pushinteger(L, result);
  return 1;
...
static int l_IVector4_set_w(lua_State *L) {
  IVector4* obj = luaL_checkudata(L, 1, "IVector4");
...
static int l_IVector4_get_w(lua_State *L) {
  IVector4* obj = luaL_checkudata(L, 1, "IVector4");
  int result = obj->w;
  lua_pushinteger(L, result);
  return 1;
...
static const luaL_Reg l_IVector4[] = {
  {"getX", l_IVector4_get_x},
  {"setX", l_IVector4_set_x},
  {"getY", l_IVector4_get_y},
  {"setY", l_IVector4_set_y},
  {"getZ", l_IVector4_get_z},
  {"setZ", l_IVector4_set_z},
  {"getW", l_IVector4_get_w},
  {"setW", l_IVector4_set_w},
  {"__eq", l_IVector4__eq},
  {"unpack", l_IVector4_unpack},
  {NULL, NULL}
};

static void l_IVector4_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "IVector4");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_IVector4, 0);
  lua_pop(L, 1);
}

static int l_VrDeviceInfo_set_hResolution(lua_State *L) {
...
static int l_VrDeviceInfo_get_hResolution(lua_State *L) {
  VrDeviceInfo* obj = luaL_checkudata(L, 1, "VrDeviceInfo");
...
static int l_VrDeviceInfo_set_vResolution(lua_State *L) {
  VrDeviceInfo* obj = luaL_checkudata(L, 1, "VrDeviceInfo");
...
static int l_VrDeviceInfo_get_vResolution(lua_State *L) {
  VrDeviceInfo* obj = luaL_checkudata(L, 1, "VrDeviceInfo");
...
static int l_VrDeviceInfo_set_hScreenSize(lua_State *L) {
  VrDeviceInfo* obj = luaL_checkudata(L, 1, "VrDeviceInfo");
...
static int l_VrDeviceInfo_get_hScreenSize(lua_State *L) {
  VrDeviceInfo* obj = luaL_checkudata(L, 1, "VrDeviceInfo");
...
static int l_VrDeviceInfo_set_vScreenSize(lua_State *L) {
  VrDeviceInfo* obj = luaL_checkudata(L, 1, "VrDeviceInfo");
...
static int l_VrDeviceInfo_get_vScreenSize(lua_State *L) {
  VrDeviceInfo* obj = luaL_checkudata(L, 1, "VrDeviceInfo");
...
static int l_VrDeviceInfo_set_vScreenCenter(lua_State *L) {
  VrDeviceInfo* obj = luaL_checkudata(L, 1, "VrDeviceInfo");
...
static int l_VrDeviceInfo_get_vScreenCenter(lua_State *L) {
  VrDeviceInfo* obj = luaL_checkudata(L, 1, "VrDeviceInfo");
...
static int l_VrDeviceInfo_set_eyeToScreenDistance(lua_State *L) {
  VrDeviceInfo* obj = luaL_checkudata(L, 1, "VrDeviceInfo");
...
static int l_VrDeviceInfo_get_eyeToScreenDistance(lua_State *L) {
  VrDeviceInfo* obj = luaL_checkudata(L, 1, "VrDeviceInfo");
...
static int l_VrDeviceInfo_set_lensSeparationDistance(lua_State *L) {
  VrDeviceInfo* obj = luaL_checkudata(L, 1, "VrDeviceInfo");
...
static int l_VrDeviceInfo_get_lensSeparationDistance(lua_State *L) {
  VrDeviceInfo* obj = luaL_checkudata(L, 1, "VrDeviceInfo");
...
static int l_VrDeviceInfo_set_interpupillaryDistance(lua_State *L) {
  VrDeviceInfo* obj = luaL_checkudata(L, 1, "VrDeviceInfo");
...
static int l_VrDeviceInfo_get_interpupillaryDistance(lua_State *L) {
  VrDeviceInfo* obj = luaL_checkudata(L, 1, "VrDeviceInfo");
...
static int l_VrDeviceInfo_set_lensDistortionValuAt(lua_State *L) {
  VrDeviceInfo* obj = luaL_checkudata(L, 1, "VrDeviceInfo");
  int idx = luaL_checkinteger(L, 2);
...
static int l_VrDeviceInfo_get_lensDistortionValuAt(lua_State *L) {
  VrDeviceInfo* obj = luaL_checkudata(L, 1, "VrDeviceInfo");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0 || idx >= 4) return luaL_error(L, "Index out of bounds %d", idx, 4);
...
static int l_VrDeviceInfo_set_chromaAbCorrectionAt(lua_State *L) {
  VrDeviceInfo* obj = luaL_checkudata(L, 1, "VrDeviceInfo");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0 || idx >= 4) return luaL_error(L, "Index out of bounds %d", idx, 4);
...
static int l_VrDeviceInfo_get_chromaAbCorrectionAt(lua_State *L) {
  VrDeviceInfo* obj = luaL_checkudata(L, 1, "VrDeviceInfo");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0 || idx >= 4) return luaL_error(L, "Index out of bounds %d", idx, 4);
...
static const luaL_Reg l_VrDeviceInfo[] = {
  {"getHResolution", l_VrDeviceInfo_get_hResolution},
  {"setHResolution", l_VrDeviceInfo_set_hResolution},
  {"getVResolution", l_VrDeviceInfo_get_vResolution},
  {"setVResolution", l_VrDeviceInfo_set_vResolution},
  {"getHScreenSize", l_VrDeviceInfo_get_hScreenSize},
  {"setHScreenSize", l_VrDeviceInfo_set_hScreenSize},
  {"getVScreenSize", l_VrDeviceInfo_get_vScreenSize},
  {"setVScreenSize", l_VrDeviceInfo_set_vScreenSize},
  {"getVScreenCenter", l_VrDeviceInfo_get_vScreenCenter},
  {"setVScreenCenter", l_VrDeviceInfo_set_vScreenCenter},
  {"getEyeToScreenDistance", l_VrDeviceInfo_get_eyeToScreenDistance},
  {"setEyeToScreenDistance", l_VrDeviceInfo_set_eyeToScreenDistance},
  {"getLensSeparationDistance", l_VrDeviceInfo_get_lensSeparationDistance},
  {"setLensSeparationDistance", l_VrDeviceInfo_set_lensSeparationDistance},
  {"getInterpupillaryDistance", l_VrDeviceInfo_get_interpupillaryDistance},
  {"setInterpupillaryDistance", l_VrDeviceInfo_set_interpupillaryDistance},
  {"getLensDistortionValuAt", l_VrDeviceInfo_get_lensDistortionValuAt},
  {"setLensDistortionValuAt", l_VrDeviceInfo_set_lensDistortionValuAt},
  {"getChromaAbCorrectionAt", l_VrDeviceInfo_get_chromaAbCorrectionAt},
  {"setChromaAbCorrectionAt", l_VrDeviceInfo_set_chromaAbCorrectionAt},
  {NULL, NULL}
};

static void l_VrDeviceInfo_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "VrDeviceInfo");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_VrDeviceInfo, 0);
  lua_pop(L, 1);
}

static int l_NPatchInfo_set_sourceRec(lua_State *L) {
...
static int l_NPatchInfo_get_sourceRec(lua_State *L) {
  NPatchInfo* obj = luaL_checkudata(L, 1, "NPatchInfo");
...
static int l_NPatchInfo_set_sourceRecU(lua_State *L) {
  NPatchInfo* obj = luaL_checkudata(L, 1, "NPatchInfo");
...
static int l_NPatchInfo_get_sourceRecU(lua_State *L) {
  NPatchInfo* obj = luaL_checkudata(L, 1, "NPatchInfo");
  Rectangle result = obj->sourceRec;
  lua_pushnumber(L, result.x);lua_pushnumber(L, result.y);lua_pushnumber(L, result.width);lua_pushnumber(L, result.height);
  return 4;
...
static int l_NPatchInfo_set_left(lua_State *L) {
  NPatchInfo* obj = luaL_checkudata(L, 1, "NPatchInfo");
...
static int l_NPatchInfo_get_left(lua_State *L) {
  NPatchInfo* obj = luaL_checkudata(L, 1, "NPatchInfo");
  int result = obj->left;
  lua_pushinteger(L, result);
  return 1;
...
static int l_NPatchInfo_set_top(lua_State *L) {
  NPatchInfo* obj = luaL_checkudata(L, 1, "NPatchInfo");
...
static int l_NPatchInfo_get_top(lua_State *L) {
  NPatchInfo* obj = luaL_checkudata(L, 1, "NPatchInfo");
  int result = obj->top;
  lua_pushinteger(L, result);
  return 1;
...
static int l_NPatchInfo_set_right(lua_State *L) {
  NPatchInfo* obj = luaL_checkudata(L, 1, "NPatchInfo");
...
static int l_NPatchInfo_get_right(lua_State *L) {
  NPatchInfo* obj = luaL_checkudata(L, 1, "NPatchInfo");
...
static int l_NPatchInfo_set_bottom(lua_State *L) {
  NPatchInfo* obj = luaL_checkudata(L, 1, "NPatchInfo");
...
static int l_NPatchInfo_get_bottom(lua_State *L) {
  NPatchInfo* obj = luaL_checkudata(L, 1, "NPatchInfo");
...
static int l_NPatchInfo_set_type(lua_State *L) {
  NPatchInfo* obj = luaL_checkudata(L, 1, "NPatchInfo");
...
static int l_NPatchInfo_get_type(lua_State *L) {
  NPatchInfo* obj = luaL_checkudata(L, 1, "NPatchInfo");
  int result = obj->type;
  lua_pushinteger(L, result);
  return 1;
...
static const luaL_Reg l_NPatchInfo[] = {
  {"getSourceRec", l_NPatchInfo_get_sourceRec},
  {"setSourceRec", l_NPatchInfo_set_sourceRec},
  {"getSourceRecU", l_NPatchInfo_get_sourceRecU},
  {"setSourceRecU", l_NPatchInfo_set_sourceRecU},
  {"getLeft", l_NPatchInfo_get_left},
  {"setLeft", l_NPatchInfo_set_left},
  {"getTop", l_NPatchInfo_get_top},
  {"setTop", l_NPatchInfo_set_top},
  {"getRight", l_NPatchInfo_get_right},
  {"setRight", l_NPatchInfo_set_right},
  {"getBottom", l_NPatchInfo_get_bottom},
  {"setBottom", l_NPatchInfo_set_bottom},
  {"getType", l_NPatchInfo_get_type},
  {"setType", l_NPatchInfo_set_type},
  {NULL, NULL}
};

static void l_NPatchInfo_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "NPatchInfo");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_NPatchInfo, 0);
  lua_pop(L, 1);
}

static int l_Material_set_shader(lua_State *L) {
...
static int l_Material_get_shader(lua_State *L) {
  Material* obj = luaL_checkudata(L, 1, "Material");
...
static int l_Material_set_mapAt(lua_State *L) {
  Material* obj = luaL_checkudata(L, 1, "Material");
  int idx = luaL_checkinteger(L, 2);
...
static int l_Material_get_mapAt(lua_State *L) {
  Material* obj = luaL_checkudata(L, 1, "Material");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0 || idx >= MAX_MATERIAL_MAPS) return luaL_error(L, "Index out of bounds %d", idx, MAX_MATERIAL_MAPS);
...
static int l_Material_set_paramAt(lua_State *L) {
  Material* obj = luaL_checkudata(L, 1, "Material");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Material_get_paramAt(lua_State *L) {
  Material* obj = luaL_checkudata(L, 1, "Material");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static const luaL_Reg l_Material[] = {
  {"getShader", l_Material_get_shader},
  {"setShader", l_Material_set_shader},
  {"getMapAt", l_Material_get_mapAt},
  {"setMapAt", l_Material_set_mapAt},
  {"getParamAt", l_Material_get_paramAt},
  {"setParamAt", l_Material_set_paramAt},
  {NULL, NULL}
};

static void l_Material_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "Material");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_Material, 0);
  lua_pop(L, 1);
}

static int l_Vector2__eq(lua_State *L) {
  lua_getmetatable(L, 1); lua_getmetatable(L, 2);
  if (lua_rawequal(L, -1, -2) == 0) {
    lua_pushboolean(L, 0);
  } else {
...
static int l_Vector2_unpack(lua_State *L) {
...
static int l_Vector2_set_x(lua_State *L) {
...
static int l_Vector2_get_x(lua_State *L) {
  Vector2* obj = luaL_checkudata(L, 1, "Vector2");
  float result = obj->x;
  lua_pushnumber(L, result);
  return 1;
...
static int l_Vector2_set_y(lua_State *L) {
  Vector2* obj = luaL_checkudata(L, 1, "Vector2");
...
static int l_Vector2_get_y(lua_State *L) {
  Vector2* obj = luaL_checkudata(L, 1, "Vector2");
  float result = obj->y;
  lua_pushnumber(L, result);
  return 1;
...
static const luaL_Reg l_Vector2[] = {
  {"getX", l_Vector2_get_x},
  {"setX", l_Vector2_set_x},
  {"getY", l_Vector2_get_y},
  {"setY", l_Vector2_set_y},
  {"__eq", l_Vector2__eq},
  {"unpack", l_Vector2_unpack},
  {NULL, NULL}
};

static void l_Vector2_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "Vector2");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_Vector2, 0);
  lua_pop(L, 1);
}

static int l_Rectangle__eq(lua_State *L) {
  lua_getmetatable(L, 1); lua_getmetatable(L, 2);
  if (lua_rawequal(L, -1, -2) == 0) {
    lua_pushboolean(L, 0);
  } else {
...
static int l_Rectangle_unpack(lua_State *L) {
...
static int l_Rectangle_set_x(lua_State *L) {
...
static int l_Rectangle_get_x(lua_State *L) {
  Rectangle* obj = luaL_checkudata(L, 1, "Rectangle");
  float result = obj->x;
  lua_pushnumber(L, result);
  return 1;
...
static int l_Rectangle_set_y(lua_State *L) {
  Rectangle* obj = luaL_checkudata(L, 1, "Rectangle");
  float y = luaL_checknumber(L, 2);
  obj->y = y;
  lua_pop(L, 1);
...
static int l_Rectangle_get_y(lua_State *L) {
  Rectangle* obj = luaL_checkudata(L, 1, "Rectangle");
  float result = obj->y;
  lua_pushnumber(L, result);
  return 1;
...
static int l_Rectangle_set_width(lua_State *L) {
  Rectangle* obj = luaL_checkudata(L, 1, "Rectangle");
  float width = luaL_checknumber(L, 2);
  obj->width = width;
  lua_pop(L, 1);
...
static int l_Rectangle_get_width(lua_State *L) {
  Rectangle* obj = luaL_checkudata(L, 1, "Rectangle");
...
static int l_Rectangle_set_height(lua_State *L) {
  Rectangle* obj = luaL_checkudata(L, 1, "Rectangle");
  float height = luaL_checknumber(L, 2);
  obj->height = height;
  lua_pop(L, 1);
...
static int l_Rectangle_get_height(lua_State *L) {
  Rectangle* obj = luaL_checkudata(L, 1, "Rectangle");
...
static const luaL_Reg l_Rectangle[] = {
  {"getX", l_Rectangle_get_x},
  {"setX", l_Rectangle_set_x},
  {"getY", l_Rectangle_get_y},
  {"setY", l_Rectangle_set_y},
  {"getWidth", l_Rectangle_get_width},
  {"setWidth", l_Rectangle_set_width},
  {"getHeight", l_Rectangle_get_height},
  {"setHeight", l_Rectangle_set_height},
  {"__eq", l_Rectangle__eq},
  {"unpack", l_Rectangle_unpack},
  {NULL, NULL}
};

static void l_Rectangle_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "Rectangle");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_Rectangle, 0);
  lua_pop(L, 1);
}

static int l_BoundingBox_set_min(lua_State *L) {
...
static int l_BoundingBox_get_min(lua_State *L) {
  BoundingBox* obj = luaL_checkudata(L, 1, "BoundingBox");
...
static int l_BoundingBox_set_minU(lua_State *L) {
  BoundingBox* obj = luaL_checkudata(L, 1, "BoundingBox");
...
static int l_BoundingBox_get_minU(lua_State *L) {
  BoundingBox* obj = luaL_checkudata(L, 1, "BoundingBox");
  Vector3 result = obj->min;
  lua_pushnumber(L, result.x);lua_pushnumber(L, result.y);lua_pushnumber(L, result.z);
  return 3;
...
static int l_BoundingBox_set_max(lua_State *L) {
  BoundingBox* obj = luaL_checkudata(L, 1, "BoundingBox");
...
static int l_BoundingBox_get_max(lua_State *L) {
  BoundingBox* obj = luaL_checkudata(L, 1, "BoundingBox");
...
static int l_BoundingBox_set_maxU(lua_State *L) {
  BoundingBox* obj = luaL_checkudata(L, 1, "BoundingBox");
...
static int l_BoundingBox_get_maxU(lua_State *L) {
  BoundingBox* obj = luaL_checkudata(L, 1, "BoundingBox");
  Vector3 result = obj->max;
  lua_pushnumber(L, result.x);lua_pushnumber(L, result.y);lua_pushnumber(L, result.z);
  return 3;
...
static const luaL_Reg l_BoundingBox[] = {
  {"getMin", l_BoundingBox_get_min},
  {"setMin", l_BoundingBox_set_min},
  {"getMinU", l_BoundingBox_get_minU},
  {"setMinU", l_BoundingBox_set_minU},
  {"getMax", l_BoundingBox_get_max},
  {"setMax", l_BoundingBox_set_max},
  {"getMaxU", l_BoundingBox_get_maxU},
  {"setMaxU", l_BoundingBox_set_maxU},
  {NULL, NULL}
};

static void l_BoundingBox_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "BoundingBox");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_BoundingBox, 0);
  lua_pop(L, 1);
}
...
static int l_Camera2D_set_offsetU(lua_State *L) {
  Camera2D* obj = luaL_checkudata(L, 1, "Camera2D");
...
static int l_Camera2D_get_offsetU(lua_State *L) {
  Camera2D* obj = luaL_checkudata(L, 1, "Camera2D");
  Vector2 result = obj->offset;
  lua_pushnumber(L, result.x);lua_pushnumber(L, result.y);
  return 2;
...
static int l_Camera2D_get_target(lua_State *L) {
  Camera2D* obj = luaL_checkudata(L, 1, "Camera2D");
...
static int l_Camera2D_set_targetU(lua_State *L) {
  Camera2D* obj = luaL_checkudata(L, 1, "Camera2D");
...
static int l_Camera2D_get_targetU(lua_State *L) {
  Camera2D* obj = luaL_checkudata(L, 1, "Camera2D");
  Vector2 result = obj->target;
  lua_pushnumber(L, result.x);lua_pushnumber(L, result.y);
  return 2;
...
static const luaL_Reg l_Camera2D[] = {
  {"getOffset", l_Camera2D_get_offset},
  {"setOffset", l_Camera2D_set_offset},
  {"getOffsetU", l_Camera2D_get_offsetU},
  {"setOffsetU", l_Camera2D_set_offsetU},
  {"getTarget", l_Camera2D_get_target},
  {"setTarget", l_Camera2D_set_target},
  {"getTargetU", l_Camera2D_get_targetU},
  {"setTargetU", l_Camera2D_set_targetU},
  {"getRotation", l_Camera2D_get_rotation},
  {"setRotation", l_Camera2D_set_rotation},
  {"getZoom", l_Camera2D_get_zoom},
  {"setZoom", l_Camera2D_set_zoom},
  {NULL, NULL}
};

static void l_Camera2D_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "Camera2D");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_Camera2D, 0);
  lua_pop(L, 1);
}

static int l_Vector3__eq(lua_State *L) {
  lua_getmetatable(L, 1); lua_getmetatable(L, 2);
  if (lua_rawequal(L, -1, -2) == 0) {
    lua_pushboolean(L, 0);
  } else {
...
static int l_Vector3_unpack(lua_State *L) {
...
static int l_Vector3_set_x(lua_State *L) {
...
static int l_Vector3_get_x(lua_State *L) {
  Vector3* obj = luaL_checkudata(L, 1, "Vector3");
  float result = obj->x;
  lua_pushnumber(L, result);
  return 1;
...
static int l_Vector3_set_y(lua_State *L) {
  Vector3* obj = luaL_checkudata(L, 1, "Vector3");
  float y = luaL_checknumber(L, 2);
  obj->y = y;
  lua_pop(L, 1);
...
static int l_Vector3_get_y(lua_State *L) {
  Vector3* obj = luaL_checkudata(L, 1, "Vector3");
  float result = obj->y;
  lua_pushnumber(L, result);
  return 1;
...
static int l_Vector3_set_z(lua_State *L) {
  Vector3* obj = luaL_checkudata(L, 1, "Vector3");
...
static int l_Vector3_get_z(lua_State *L) {
  Vector3* obj = luaL_checkudata(L, 1, "Vector3");
  float result = obj->z;
  lua_pushnumber(L, result);
  return 1;
...
static const luaL_Reg l_Vector3[] = {
  {"getX", l_Vector3_get_x},
  {"setX", l_Vector3_set_x},
  {"getY", l_Vector3_get_y},
  {"setY", l_Vector3_set_y},
  {"getZ", l_Vector3_get_z},
  {"setZ", l_Vector3_set_z},
  {"__eq", l_Vector3__eq},
  {"unpack", l_Vector3_unpack},
  {NULL, NULL}
};

static void l_Vector3_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "Vector3");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_Vector3, 0);
  lua_pop(L, 1);
}

static int l_Camera3D_set_position(lua_State *L) {
...
static int l_Camera3D_get_position(lua_State *L) {
  Camera3D* obj = luaL_checkudata(L, 1, "Camera3D");
...
static int l_Camera3D_set_positionU(lua_State *L) {
  Camera3D* obj = luaL_checkudata(L, 1, "Camera3D");
  Vector3 position = {luaL_checknumber(L, 2), luaL_checknumber(L, 3), luaL_checknumber(L, 4)};
  obj->position = position;
  lua_pop(L, 3);
...
static int l_Camera3D_get_positionU(lua_State *L) {
  Camera3D* obj = luaL_checkudata(L, 1, "Camera3D");
  Vector3 result = obj->position;
  lua_pushnumber(L, result.x);lua_pushnumber(L, result.y);lua_pushnumber(L, result.z);
  return 3;
...
static int l_Camera3D_set_target(lua_State *L) {
  Camera3D* obj = luaL_checkudata(L, 1, "Camera3D");
...
static int l_Camera3D_get_target(lua_State *L) {
  Camera3D* obj = luaL_checkudata(L, 1, "Camera3D");
...
static int l_Camera3D_set_targetU(lua_State *L) {
  Camera3D* obj = luaL_checkudata(L, 1, "Camera3D");
...
static int l_Camera3D_get_targetU(lua_State *L) {
  Camera3D* obj = luaL_checkudata(L, 1, "Camera3D");
  Vector3 result = obj->target;
  lua_pushnumber(L, result.x);lua_pushnumber(L, result.y);lua_pushnumber(L, result.z);
  return 3;
...
static int l_Camera3D_set_up(lua_State *L) {
  Camera3D* obj = luaL_checkudata(L, 1, "Camera3D");
...
static int l_Camera3D_get_up(lua_State *L) {
  Camera3D* obj = luaL_checkudata(L, 1, "Camera3D");
...
static int l_Camera3D_set_upU(lua_State *L) {
  Camera3D* obj = luaL_checkudata(L, 1, "Camera3D");
...
static int l_Camera3D_get_upU(lua_State *L) {
  Camera3D* obj = luaL_checkudata(L, 1, "Camera3D");
  Vector3 result = obj->up;
  lua_pushnumber(L, result.x);lua_pushnumber(L, result.y);lua_pushnumber(L, result.z);
  return 3;
...
static int l_Camera3D_set_fovy(lua_State *L) {
  Camera3D* obj = luaL_checkudata(L, 1, "Camera3D");
...
static int l_Camera3D_get_fovy(lua_State *L) {
  Camera3D* obj = luaL_checkudata(L, 1, "Camera3D");
...
static int l_Camera3D_set_type(lua_State *L) {
  Camera3D* obj = luaL_checkudata(L, 1, "Camera3D");
  int type = luaL_checkinteger(L, 2);
  obj->type = type;
  lua_pop(L, 1);
...
static int l_Camera3D_get_type(lua_State *L) {
  Camera3D* obj = luaL_checkudata(L, 1, "Camera3D");
  int result = obj->type;
  lua_pushinteger(L, result);
  return 1;
...
static const luaL_Reg l_Camera3D[] = {
  {"getPosition", l_Camera3D_get_position},
  {"setPosition", l_Camera3D_set_position},
  {"getPositionU", l_Camera3D_get_positionU},
  {"setPositionU", l_Camera3D_set_positionU},
  {"getTarget", l_Camera3D_get_target},
  {"setTarget", l_Camera3D_set_target},
  {"getTargetU", l_Camera3D_get_targetU},
  {"setTargetU", l_Camera3D_set_targetU},
  {"getUp", l_Camera3D_get_up},
  {"setUp", l_Camera3D_set_up},
  {"getUpU", l_Camera3D_get_upU},
  {"setUpU", l_Camera3D_set_upU},
  {"getFovy", l_Camera3D_get_fovy},
  {"setFovy", l_Camera3D_set_fovy},
  {"getType", l_Camera3D_get_type},
  {"setType", l_Camera3D_set_type},
  {NULL, NULL}
};

static void l_Camera3D_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "Camera3D");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_Camera3D, 0);
  lua_pop(L, 1);
}

static int l_Mesh_set_vertexCount(lua_State *L) {
...
static int l_Mesh_get_vertexCount(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
...
static int l_Mesh_set_triangleCount(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
...
static int l_Mesh_get_triangleCount(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
...
static int l_Mesh_set_vertixAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
...
static int l_Mesh_get_vertixAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0 || idx >= obj->vertexCount) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_set_texcoordAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_get_texcoordAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_set_texcoords2At(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_get_texcoords2At(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_set_normalAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_get_normalAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_set_tangentAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_get_tangentAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_set_colorAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_get_colorAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_set_indixAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_get_indixAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_set_animVertixAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_get_animVertixAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_set_animNormalAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_get_animNormalAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_set_boneIdAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_get_boneIdAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_set_boneWeightAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_get_boneWeightAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Mesh_set_vaoId(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
...
static int l_Mesh_get_vaoId(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
...
static int l_Mesh_set_vboIdAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
...
static int l_Mesh_get_vboIdAt(lua_State *L) {
  Mesh* obj = luaL_checkudata(L, 1, "Mesh");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0 || idx >= 7) return luaL_error(L, "Index out of bounds %d", idx, 7);
...
static const luaL_Reg l_Mesh[] = {
  {"getVertexCount", l_Mesh_get_vertexCount},
  {"setVertexCount", l_Mesh_set_vertexCount},
  {"getTriangleCount", l_Mesh_get_triangleCount},
  {"setTriangleCount", l_Mesh_set_triangleCount},
  {"getVertixAt", l_Mesh_get_vertixAt},
  {"setVertixAt", l_Mesh_set_vertixAt},
  {"getTexcoordAt", l_Mesh_get_texcoordAt},
  {"setTexcoordAt", l_Mesh_set_texcoordAt},
  {"getTexcoords2At", l_Mesh_get_texcoords2At},
  {"setTexcoords2At", l_Mesh_set_texcoords2At},
  {"getNormalAt", l_Mesh_get_normalAt},
  {"setNormalAt", l_Mesh_set_normalAt},
  {"getTangentAt", l_Mesh_get_tangentAt},
  {"setTangentAt", l_Mesh_set_tangentAt},
  {"getColorAt", l_Mesh_get_colorAt},
  {"setColorAt", l_Mesh_set_colorAt},
  {"getIndixAt", l_Mesh_get_indixAt},
  {"setIndixAt", l_Mesh_set_indixAt},
  {"getAnimVertixAt", l_Mesh_get_animVertixAt},
  {"setAnimVertixAt", l_Mesh_set_animVertixAt},
  {"getAnimNormalAt", l_Mesh_get_animNormalAt},
  {"setAnimNormalAt", l_Mesh_set_animNormalAt},
  {"getBoneIdAt", l_Mesh_get_boneIdAt},
  {"setBoneIdAt", l_Mesh_set_boneIdAt},
  {"getBoneWeightAt", l_Mesh_get_boneWeightAt},
  {"setBoneWeightAt", l_Mesh_set_boneWeightAt},
  {"getVaoId", l_Mesh_get_vaoId},
  {"setVaoId", l_Mesh_set_vaoId},
  {"getVboIdAt", l_Mesh_get_vboIdAt},
  {"setVboIdAt", l_Mesh_set_vboIdAt},
  {NULL, NULL}
};

static void l_Mesh_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "Mesh");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_Mesh, 0);
  lua_pop(L, 1);
}

static int l_AudioStream_set_sampleRate(lua_State *L) {
...
static int l_AudioStream_get_sampleRate(lua_State *L) {
  AudioStream* obj = luaL_checkudata(L, 1, "AudioStream");
  unsigned int result = obj->sampleRate;
  lua_pushinteger(L, result);
  return 1;
...
static int l_AudioStream_set_sampleSize(lua_State *L) {
  AudioStream* obj = luaL_checkudata(L, 1, "AudioStream");
  unsigned int sampleSize = luaL_checkinteger(L, 2);
  obj->sampleSize = sampleSize;
  lua_pop(L, 1);
...
static int l_AudioStream_get_sampleSize(lua_State *L) {
  AudioStream* obj = luaL_checkudata(L, 1, "AudioStream");
  unsigned int result = obj->sampleSize;
  lua_pushinteger(L, result);
  return 1;
...
static int l_AudioStream_set_channels(lua_State *L) {
  AudioStream* obj = luaL_checkudata(L, 1, "AudioStream");
  unsigned int channels = luaL_checkinteger(L, 2);
  obj->channels = channels;
  lua_pop(L, 1);
...
static int l_AudioStream_get_channels(lua_State *L) {
  AudioStream* obj = luaL_checkudata(L, 1, "AudioStream");
  unsigned int result = obj->channels;
  lua_pushinteger(L, result);
  return 1;
...
static int l_AudioStream_set_audioBuffer(lua_State *L) {
  AudioStream* obj = luaL_checkudata(L, 1, "AudioStream");
...
static int l_AudioStream_get_audioBuffer(lua_State *L) {
  AudioStream* obj = luaL_checkudata(L, 1, "AudioStream");
...
static int l_AudioStream_set_format(lua_State *L) {
  AudioStream* obj = luaL_checkudata(L, 1, "AudioStream");
  int format = luaL_checkinteger(L, 2);
  obj->format = format;
  lua_pop(L, 1);
...
static int l_AudioStream_get_format(lua_State *L) {
  AudioStream* obj = luaL_checkudata(L, 1, "AudioStream");
  int result = obj->format;
  lua_pushinteger(L, result);
  return 1;
...
static int l_AudioStream_set_source(lua_State *L) {
  AudioStream* obj = luaL_checkudata(L, 1, "AudioStream");
...
static int l_AudioStream_get_source(lua_State *L) {
  AudioStream* obj = luaL_checkudata(L, 1, "AudioStream");
...
static int l_AudioStream_set_bufferAt(lua_State *L) {
  AudioStream* obj = luaL_checkudata(L, 1, "AudioStream");
  int idx = luaL_checkinteger(L, 2);
...
static int l_AudioStream_get_bufferAt(lua_State *L) {
  AudioStream* obj = luaL_checkudata(L, 1, "AudioStream");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0 || idx >= 2) return luaL_error(L, "Index out of bounds %d", idx, 2);
...
static const luaL_Reg l_AudioStream[] = {
  {"getSampleRate", l_AudioStream_get_sampleRate},
  {"setSampleRate", l_AudioStream_set_sampleRate},
  {"getSampleSize", l_AudioStream_get_sampleSize},
  {"setSampleSize", l_AudioStream_set_sampleSize},
  {"getChannels", l_AudioStream_get_channels},
  {"setChannels", l_AudioStream_set_channels},
  {"getAudioBuffer", l_AudioStream_get_audioBuffer},
  {"setAudioBuffer", l_AudioStream_set_audioBuffer},
  {"getFormat", l_AudioStream_get_format},
  {"setFormat", l_AudioStream_set_format},
  {"getSource", l_AudioStream_get_source},
  {"setSource", l_AudioStream_set_source},
  {"getBufferAt", l_AudioStream_get_bufferAt},
  {"setBufferAt", l_AudioStream_set_bufferAt},
  {NULL, NULL}
};

static void l_AudioStream_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "AudioStream");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_AudioStream, 0);
  lua_pop(L, 1);
}

static int l_Texture2D__eq(lua_State *L) {
  lua_getmetatable(L, 1); lua_getmetatable(L, 2);
  if (lua_rawequal(L, -1, -2) == 0) {
    lua_pushboolean(L, 0);
  } else {
...
static int l_Texture2D_unpack(lua_State *L) {
...
static int l_Texture2D_set_id(lua_State *L) {
...
static int l_Texture2D_get_id(lua_State *L) {
  Texture2D* obj = luaL_checkudata(L, 1, "Texture2D");
...
static int l_Texture2D_set_width(lua_State *L) {
  Texture2D* obj = luaL_checkudata(L, 1, "Texture2D");
  int width = luaL_checkinteger(L, 2);
  obj->width = width;
  lua_pop(L, 1);
...
static int l_Texture2D_get_width(lua_State *L) {
  Texture2D* obj = luaL_checkudata(L, 1, "Texture2D");
  int result = obj->width;
  lua_pushinteger(L, result);
  return 1;
...
static int l_Texture2D_set_height(lua_State *L) {
  Texture2D* obj = luaL_checkudata(L, 1, "Texture2D");
  int height = luaL_checkinteger(L, 2);
  obj->height = height;
  lua_pop(L, 1);
...
static int l_Texture2D_get_height(lua_State *L) {
  Texture2D* obj = luaL_checkudata(L, 1, "Texture2D");
  int result = obj->height;
  lua_pushinteger(L, result);
  return 1;
...
static int l_Texture2D_set_mipmaps(lua_State *L) {
  Texture2D* obj = luaL_checkudata(L, 1, "Texture2D");
  int mipmaps = luaL_checkinteger(L, 2);
  obj->mipmaps = mipmaps;
  lua_pop(L, 1);
...
static int l_Texture2D_get_mipmaps(lua_State *L) {
  Texture2D* obj = luaL_checkudata(L, 1, "Texture2D");
  int result = obj->mipmaps;
  lua_pushinteger(L, result);
  return 1;
...
static int l_Texture2D_set_format(lua_State *L) {
  Texture2D* obj = luaL_checkudata(L, 1, "Texture2D");
  int format = luaL_checkinteger(L, 2);
  obj->format = format;
  lua_pop(L, 1);
...
static int l_Texture2D_get_format(lua_State *L) {
  Texture2D* obj = luaL_checkudata(L, 1, "Texture2D");
  int result = obj->format;
  lua_pushinteger(L, result);
  return 1;
...
static const luaL_Reg l_Texture2D[] = {
  {"getId", l_Texture2D_get_id},
  {"setId", l_Texture2D_set_id},
  {"getWidth", l_Texture2D_get_width},
  {"setWidth", l_Texture2D_set_width},
  {"getHeight", l_Texture2D_get_height},
  {"setHeight", l_Texture2D_set_height},
  {"getMipmaps", l_Texture2D_get_mipmaps},
  {"setMipmaps", l_Texture2D_set_mipmaps},
  {"getFormat", l_Texture2D_get_format},
  {"setFormat", l_Texture2D_set_format},
  {"__eq", l_Texture2D__eq},
  {"unpack", l_Texture2D_unpack},
  {NULL, NULL}
};

static void l_Texture2D_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "Texture2D");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_Texture2D, 0);
  lua_pop(L, 1);
}

static int l_Font_set_texture(lua_State *L) {
...
static int l_Font_get_texture(lua_State *L) {
  Font* obj = luaL_checkudata(L, 1, "Font");
...
static int l_Font_set_textureU(lua_State *L) {
  Font* obj = luaL_checkudata(L, 1, "Font");
  Texture2D texture = {luaL_checkinteger(L, 2), luaL_checkinteger(L, 3), luaL_checkinteger(L, 4), luaL_checkinteger(L, 5), luaL_checkinteger(L, 6)};
  obj->texture = texture;
  lua_pop(L, 5);
...
static int l_Font_get_textureU(lua_State *L) {
  Font* obj = luaL_checkudata(L, 1, "Font");
  Texture2D result = obj->texture;
  lua_pushinteger(L, result.id);lua_pushinteger(L, result.width);lua_pushinteger(L, result.height);lua_pushinteger(L, result.mipmaps);lua_pushinteger(L, result.format);
  return 5;
...
static int l_Font_set_baseSize(lua_State *L) {
  Font* obj = luaL_checkudata(L, 1, "Font");
...
static int l_Font_get_baseSize(lua_State *L) {
  Font* obj = luaL_checkudata(L, 1, "Font");
...
static int l_Font_set_charsCount(lua_State *L) {
  Font* obj = luaL_checkudata(L, 1, "Font");
  int charsCount = luaL_checkinteger(L, 2);
...
static int l_Font_get_charsCount(lua_State *L) {
  Font* obj = luaL_checkudata(L, 1, "Font");
...
static int l_Font_set_charAt(lua_State *L) {
  Font* obj = luaL_checkudata(L, 1, "Font");
  int idx = luaL_checkinteger(L, 2);
...
static int l_Font_get_charAt(lua_State *L) {
  Font* obj = luaL_checkudata(L, 1, "Font");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0 || idx >= obj->charsCount) return luaL_error(L, "Index out of bounds %d", idx);
...
static const luaL_Reg l_Font[] = {
  {"getTexture", l_Font_get_texture},
  {"setTexture", l_Font_set_texture},
  {"getTextureU", l_Font_get_textureU},
  {"setTextureU", l_Font_set_textureU},
  {"getBaseSize", l_Font_get_baseSize},
  {"setBaseSize", l_Font_set_baseSize},
  {"getCharsCount", l_Font_get_charsCount},
  {"setCharsCount", l_Font_set_charsCount},
  {"getCharAt", l_Font_get_charAt},
  {"setCharAt", l_Font_set_charAt},
  {NULL, NULL}
};

static void l_Font_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "Font");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_Font, 0);
  lua_pop(L, 1);
}

static int l_Sound_set_audioBuffer(lua_State *L) {
...
static int l_Sound_get_audioBuffer(lua_State *L) {
  Sound* obj = luaL_checkudata(L, 1, "Sound");
  void* result = obj->audioBuffer;
  if (result == NULL) lua_pushnil(L); else lua_pushlightuserdata(L, result);
  return 1;
...
static int l_Sound_set_source(lua_State *L) {
  Sound* obj = luaL_checkudata(L, 1, "Sound");
  unsigned int source = luaL_checkinteger(L, 2);
  obj->source = source;
  lua_pop(L, 1);
...
static int l_Sound_get_source(lua_State *L) {
  Sound* obj = luaL_checkudata(L, 1, "Sound");
  unsigned int result = obj->source;
  lua_pushinteger(L, result);
  return 1;
...
static int l_Sound_set_buffer(lua_State *L) {
  Sound* obj = luaL_checkudata(L, 1, "Sound");
...
static int l_Sound_get_buffer(lua_State *L) {
  Sound* obj = luaL_checkudata(L, 1, "Sound");
...
static int l_Sound_set_format(lua_State *L) {
  Sound* obj = luaL_checkudata(L, 1, "Sound");
  int format = luaL_checkinteger(L, 2);
  obj->format = format;
  lua_pop(L, 1);
...
static int l_Sound_get_format(lua_State *L) {
  Sound* obj = luaL_checkudata(L, 1, "Sound");
  int result = obj->format;
  lua_pushinteger(L, result);
  return 1;
...
static const luaL_Reg l_Sound[] = {
  {"getAudioBuffer", l_Sound_get_audioBuffer},
  {"setAudioBuffer", l_Sound_set_audioBuffer},
  {"getSource", l_Sound_get_source},
  {"setSource", l_Sound_set_source},
  {"getBuffer", l_Sound_get_buffer},
  {"setBuffer", l_Sound_set_buffer},
  {"getFormat", l_Sound_get_format},
  {"setFormat", l_Sound_set_format},
  {NULL, NULL}
};

static void l_Sound_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "Sound");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_Sound, 0);
  lua_pop(L, 1);
}

static int l_BoneInfo_set_nameAt(lua_State *L) {
...
static int l_BoneInfo_get_nameAt(lua_State *L) {
  BoneInfo* obj = luaL_checkudata(L, 1, "BoneInfo");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0 || idx >= 32) return luaL_error(L, "Index out of bounds %d", idx, 32);
...
static int l_BoneInfo_set_parent(lua_State *L) {
  BoneInfo* obj = luaL_checkudata(L, 1, "BoneInfo");
...
static int l_BoneInfo_get_parent(lua_State *L) {
  BoneInfo* obj = luaL_checkudata(L, 1, "BoneInfo");
...
static const luaL_Reg l_BoneInfo[] = {
  {"getNameAt", l_BoneInfo_get_nameAt},
  {"setNameAt", l_BoneInfo_set_nameAt},
  {"getParent", l_BoneInfo_get_parent},
  {"setParent", l_BoneInfo_set_parent},
  {NULL, NULL}
};

static void l_BoneInfo_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "BoneInfo");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_BoneInfo, 0);
  lua_pop(L, 1);
}

static int l_MaterialMap_set_texture(lua_State *L) {
...
static int l_MaterialMap_get_texture(lua_State *L) {
  MaterialMap* obj = luaL_checkudata(L, 1, "MaterialMap");
  Texture2D result = obj->texture;
  Texture2D* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = result; luaL_setmetatable(L, "Texture2D");
  return 1;
...
static int l_MaterialMap_set_textureU(lua_State *L) {
  MaterialMap* obj = luaL_checkudata(L, 1, "MaterialMap");
  Texture2D texture = {luaL_checkinteger(L, 2), luaL_checkinteger(L, 3), luaL_checkinteger(L, 4), luaL_checkinteger(L, 5), luaL_checkinteger(L, 6)};
  obj->texture = texture;
  lua_pop(L, 5);
...
static int l_MaterialMap_get_textureU(lua_State *L) {
  MaterialMap* obj = luaL_checkudata(L, 1, "MaterialMap");
  Texture2D result = obj->texture;
  lua_pushinteger(L, result.id);lua_pushinteger(L, result.width);lua_pushinteger(L, result.height);lua_pushinteger(L, result.mipmaps);lua_pushinteger(L, result.format);
  return 5;
...
static int l_MaterialMap_set_color(lua_State *L) {
  MaterialMap* obj = luaL_checkudata(L, 1, "MaterialMap");
  Color color = (*(Color*)luaL_checkudata(L, 2, "Color"));
  obj->color = color;
  lua_pop(L, 1);
...
static int l_MaterialMap_get_color(lua_State *L) {
  MaterialMap* obj = luaL_checkudata(L, 1, "MaterialMap");
...
static int l_MaterialMap_set_colorU(lua_State *L) {
  MaterialMap* obj = luaL_checkudata(L, 1, "MaterialMap");
  Color color = {luaL_checkinteger(L, 2), luaL_checkinteger(L, 3), luaL_checkinteger(L, 4), luaL_checkinteger(L, 5)};
  obj->color = color;
  lua_pop(L, 4);
...
static int l_MaterialMap_get_colorU(lua_State *L) {
  MaterialMap* obj = luaL_checkudata(L, 1, "MaterialMap");
  Color result = obj->color;
  lua_pushinteger(L, result.r);lua_pushinteger(L, result.g);lua_pushinteger(L, result.b);lua_pushinteger(L, result.a);
  return 4;
...
static int l_MaterialMap_set_value(lua_State *L) {
  MaterialMap* obj = luaL_checkudata(L, 1, "MaterialMap");
...
static int l_MaterialMap_get_value(lua_State *L) {
  MaterialMap* obj = luaL_checkudata(L, 1, "MaterialMap");
...
static const luaL_Reg l_MaterialMap[] = {
  {"getTexture", l_MaterialMap_get_texture},
  {"setTexture", l_MaterialMap_set_texture},
  {"getTextureU", l_MaterialMap_get_textureU},
  {"setTextureU", l_MaterialMap_set_textureU},
  {"getColor", l_MaterialMap_get_color},
  {"setColor", l_MaterialMap_set_color},
  {"getColorU", l_MaterialMap_get_colorU},
  {"setColorU", l_MaterialMap_set_colorU},
  {"getValue", l_MaterialMap_get_value},
  {"setValue", l_MaterialMap_set_value},
  {NULL, NULL}
};

static void l_MaterialMap_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "MaterialMap");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_MaterialMap, 0);
  lua_pop(L, 1);
}

static int l_RenderTexture2D_set_id(lua_State *L) {
...
static int l_RenderTexture2D_get_id(lua_State *L) {
  RenderTexture2D* obj = luaL_checkudata(L, 1, "RenderTexture2D");
  unsigned int result = obj->id;
  lua_pushinteger(L, result);
  return 1;
...
static int l_RenderTexture2D_set_texture(lua_State *L) {
  RenderTexture2D* obj = luaL_checkudata(L, 1, "RenderTexture2D");
  Texture2D texture = (*(Texture2D*)luaL_checkudata(L, 2, "Texture2D"));
  obj->texture = texture;
  lua_pop(L, 1);
...
static int l_RenderTexture2D_get_texture(lua_State *L) {
  RenderTexture2D* obj = luaL_checkudata(L, 1, "RenderTexture2D");
  Texture2D result = obj->texture;
  Texture2D* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = result; luaL_setmetatable(L, "Texture2D");
  return 1;
...
static int l_RenderTexture2D_set_textureU(lua_State *L) {
  RenderTexture2D* obj = luaL_checkudata(L, 1, "RenderTexture2D");
  Texture2D texture = {luaL_checkinteger(L, 2), luaL_checkinteger(L, 3), luaL_checkinteger(L, 4), luaL_checkinteger(L, 5), luaL_checkinteger(L, 6)};
  obj->texture = texture;
  lua_pop(L, 5);
...
static int l_RenderTexture2D_get_textureU(lua_State *L) {
  RenderTexture2D* obj = luaL_checkudata(L, 1, "RenderTexture2D");
  Texture2D result = obj->texture;
  lua_pushinteger(L, result.id);lua_pushinteger(L, result.width);lua_pushinteger(L, result.height);lua_pushinteger(L, result.mipmaps);lua_pushinteger(L, result.format);
  return 5;
...
static int l_RenderTexture2D_set_depth(lua_State *L) {
  RenderTexture2D* obj = luaL_checkudata(L, 1, "RenderTexture2D");
...
static int l_RenderTexture2D_get_depth(lua_State *L) {
  RenderTexture2D* obj = luaL_checkudata(L, 1, "RenderTexture2D");
...
static int l_RenderTexture2D_set_depthU(lua_State *L) {
  RenderTexture2D* obj = luaL_checkudata(L, 1, "RenderTexture2D");
...
static int l_RenderTexture2D_get_depthU(lua_State *L) {
  RenderTexture2D* obj = luaL_checkudata(L, 1, "RenderTexture2D");
  Texture2D result = obj->depth;
  lua_pushinteger(L, result.id);lua_pushinteger(L, result.width);lua_pushinteger(L, result.height);lua_pushinteger(L, result.mipmaps);lua_pushinteger(L, result.format);
  return 5;
...
static int l_RenderTexture2D_set_depthTexture(lua_State *L) {
  RenderTexture2D* obj = luaL_checkudata(L, 1, "RenderTexture2D");
...
static int l_RenderTexture2D_get_depthTexture(lua_State *L) {
  RenderTexture2D* obj = luaL_checkudata(L, 1, "RenderTexture2D");
...
static const luaL_Reg l_RenderTexture2D[] = {
  {"getId", l_RenderTexture2D_get_id},
  {"setId", l_RenderTexture2D_set_id},
  {"getTexture", l_RenderTexture2D_get_texture},
  {"setTexture", l_RenderTexture2D_set_texture},
  {"getTextureU", l_RenderTexture2D_get_textureU},
  {"setTextureU", l_RenderTexture2D_set_textureU},
  {"getDepth", l_RenderTexture2D_get_depth},
  {"setDepth", l_RenderTexture2D_set_depth},
  {"getDepthU", l_RenderTexture2D_get_depthU},
  {"setDepthU", l_RenderTexture2D_set_depthU},
  {"getDepthTexture", l_RenderTexture2D_get_depthTexture},
  {"setDepthTexture", l_RenderTexture2D_set_depthTexture},
  {NULL, NULL}
};

static void l_RenderTexture2D_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "RenderTexture2D");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_RenderTexture2D, 0);
  lua_pop(L, 1);
}

static int l_RayHitInfo_set_hit(lua_State *L) {
...
static int l_RayHitInfo_get_hit(lua_State *L) {
  RayHitInfo* obj = luaL_checkudata(L, 1, "RayHitInfo");
  bool result = obj->hit;
  lua_pushboolean(L, result);
  return 1;
...
static int l_RayHitInfo_set_distance(lua_State *L) {
  RayHitInfo* obj = luaL_checkudata(L, 1, "RayHitInfo");
...
static int l_RayHitInfo_get_distance(lua_State *L) {
  RayHitInfo* obj = luaL_checkudata(L, 1, "RayHitInfo");
...
static int l_RayHitInfo_set_position(lua_State *L) {
  RayHitInfo* obj = luaL_checkudata(L, 1, "RayHitInfo");
  Vector3 position = (*(Vector3*)luaL_checkudata(L, 2, "Vector3"));
  obj->position = position;
  lua_pop(L, 1);
...
static int l_RayHitInfo_get_position(lua_State *L) {
  RayHitInfo* obj = luaL_checkudata(L, 1, "RayHitInfo");
  Vector3 result = obj->position;
  Vector3* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = result; luaL_setmetatable(L, "Vector3");
  return 1;
...
static int l_RayHitInfo_set_positionU(lua_State *L) {
  RayHitInfo* obj = luaL_checkudata(L, 1, "RayHitInfo");
  Vector3 position = {luaL_checknumber(L, 2), luaL_checknumber(L, 3), luaL_checknumber(L, 4)};
  obj->position = position;
  lua_pop(L, 3);
...
static int l_RayHitInfo_get_positionU(lua_State *L) {
  RayHitInfo* obj = luaL_checkudata(L, 1, "RayHitInfo");
  Vector3 result = obj->position;
  lua_pushnumber(L, result.x);lua_pushnumber(L, result.y);lua_pushnumber(L, result.z);
  return 3;
...
static int l_RayHitInfo_set_normal(lua_State *L) {
  RayHitInfo* obj = luaL_checkudata(L, 1, "RayHitInfo");
...
static int l_RayHitInfo_get_normal(lua_State *L) {
  RayHitInfo* obj = luaL_checkudata(L, 1, "RayHitInfo");
...
static int l_RayHitInfo_set_normalU(lua_State *L) {
  RayHitInfo* obj = luaL_checkudata(L, 1, "RayHitInfo");
...
static int l_RayHitInfo_get_normalU(lua_State *L) {
  RayHitInfo* obj = luaL_checkudata(L, 1, "RayHitInfo");
  Vector3 result = obj->normal;
  lua_pushnumber(L, result.x);lua_pushnumber(L, result.y);lua_pushnumber(L, result.z);
  return 3;
...
static const luaL_Reg l_RayHitInfo[] = {
  {"getHit", l_RayHitInfo_get_hit},
  {"setHit", l_RayHitInfo_set_hit},
  {"getDistance", l_RayHitInfo_get_distance},
  {"setDistance", l_RayHitInfo_set_distance},
  {"getPosition", l_RayHitInfo_get_position},
  {"setPosition", l_RayHitInfo_set_position},
  {"getPositionU", l_RayHitInfo_get_positionU},
  {"setPositionU", l_RayHitInfo_set_positionU},
  {"getNormal", l_RayHitInfo_get_normal},
  {"setNormal", l_RayHitInfo_set_normal},
  {"getNormalU", l_RayHitInfo_get_normalU},
  {"setNormalU", l_RayHitInfo_set_normalU},
  {NULL, NULL}
};

static void l_RayHitInfo_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "RayHitInfo");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_RayHitInfo, 0);
  lua_pop(L, 1);
}

static int l_Vector4__eq(lua_State *L) {
  lua_getmetatable(L, 1); lua_getmetatable(L, 2);
  if (lua_rawequal(L, -1, -2) == 0) {
    lua_pushboolean(L, 0);
  } else {
...
static int l_Vector4_unpack(lua_State *L) {
...
static int l_Vector4_set_x(lua_State *L) {
...
static int l_Vector4_get_x(lua_State *L) {
  Vector4* obj = luaL_checkudata(L, 1, "Vector4");
  float result = obj->x;
  lua_pushnumber(L, result);
  return 1;
...
static int l_Vector4_set_y(lua_State *L) {
  Vector4* obj = luaL_checkudata(L, 1, "Vector4");
  float y = luaL_checknumber(L, 2);
  obj->y = y;
  lua_pop(L, 1);
...
static int l_Vector4_get_y(lua_State *L) {
  Vector4* obj = luaL_checkudata(L, 1, "Vector4");
  float result = obj->y;
  lua_pushnumber(L, result);
  return 1;
...
static int l_Vector4_set_z(lua_State *L) {
  Vector4* obj = luaL_checkudata(L, 1, "Vector4");
  float z = luaL_checknumber(L, 2);
  obj->z = z;
  lua_pop(L, 1);
...
static int l_Vector4_get_z(lua_State *L) {
  Vector4* obj = luaL_checkudata(L, 1, "Vector4");
  float result = obj->z;
  lua_pushnumber(L, result);
  return 1;
...
static int l_Vector4_set_w(lua_State *L) {
  Vector4* obj = luaL_checkudata(L, 1, "Vector4");
...
static int l_Vector4_get_w(lua_State *L) {
  Vector4* obj = luaL_checkudata(L, 1, "Vector4");
  float result = obj->w;
  lua_pushnumber(L, result);
  return 1;
...
static const luaL_Reg l_Vector4[] = {
  {"getX", l_Vector4_get_x},
  {"setX", l_Vector4_set_x},
  {"getY", l_Vector4_get_y},
  {"setY", l_Vector4_set_y},
  {"getZ", l_Vector4_get_z},
  {"setZ", l_Vector4_set_z},
  {"getW", l_Vector4_get_w},
  {"setW", l_Vector4_set_w},
  {"__eq", l_Vector4__eq},
  {"unpack", l_Vector4_unpack},
  {NULL, NULL}
};

static void l_Vector4_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "Vector4");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_Vector4, 0);
  lua_pop(L, 1);
}

static int l_Model_set_transform(lua_State *L) {
...
static int l_Model_get_transform(lua_State *L) {
  Model* obj = luaL_checkudata(L, 1, "Model");
...
static int l_Model_set_transformU(lua_State *L) {
  Model* obj = luaL_checkudata(L, 1, "Model");
...
static int l_Model_get_transformU(lua_State *L) {
  Model* obj = luaL_checkudata(L, 1, "Model");
  Matrix result = obj->transform;
  lua_pushnumber(L, result.m0);lua_pushnumber(L, result.m4);lua_pushnumber(L, result.m8);lua_pushnumber(L, result.m12);lua_pushnumber(L, result.m1);lua_pushnumber(L, result.m5);lua_pushnumber(L, result.m9);lua_pushnumber(L, result.m13);lua_pushnumber(L, result.m2);lua_pushnumber(L, result.m6);lua_pushnumber(L, result.m10);lua_pushnumber(L, result.m14);lua_pushnumber(L, result.m3);lua_pushnumber(L, result.m7);lua_pushnumber(L, result.m11);lua_pushnumber(L, result.m15);
  return 16;
...
static int l_Model_set_meshCount(lua_State *L) {
  Model* obj = luaL_checkudata(L, 1, "Model");
...
static int l_Model_get_meshCount(lua_State *L) {
  Model* obj = luaL_checkudata(L, 1, "Model");
...
static int l_Model_set_meshAt(lua_State *L) {
  Model* obj = luaL_checkudata(L, 1, "Model");
  int idx = luaL_checkinteger(L, 2);
...
static int l_Model_get_meshAt(lua_State *L) {
  Model* obj = luaL_checkudata(L, 1, "Model");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0 || idx >= obj->meshCount) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Model_set_materialCount(lua_State *L) {
  Model* obj = luaL_checkudata(L, 1, "Model");
...
static int l_Model_get_materialCount(lua_State *L) {
  Model* obj = luaL_checkudata(L, 1, "Model");
...
static int l_Model_set_materialAt(lua_State *L) {
  Model* obj = luaL_checkudata(L, 1, "Model");
  int idx = luaL_checkinteger(L, 2);
...
static int l_Model_get_materialAt(lua_State *L) {
  Model* obj = luaL_checkudata(L, 1, "Model");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0 || idx >= obj->materialCount) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Model_set_meshMaterialAt(lua_State *L) {
  Model* obj = luaL_checkudata(L, 1, "Model");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Model_get_meshMaterialAt(lua_State *L) {
  Model* obj = luaL_checkudata(L, 1, "Model");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Model_set_boneCount(lua_State *L) {
  Model* obj = luaL_checkudata(L, 1, "Model");
...
static int l_Model_get_boneCount(lua_State *L) {
  Model* obj = luaL_checkudata(L, 1, "Model");
...
static int l_Model_set_bonAt(lua_State *L) {
  Model* obj = luaL_checkudata(L, 1, "Model");
  int idx = luaL_checkinteger(L, 2);
...
static int l_Model_get_bonAt(lua_State *L) {
  Model* obj = luaL_checkudata(L, 1, "Model");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0 || idx >= obj->boneCount) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Model_set_bindPoseAt(lua_State *L) {
  Model* obj = luaL_checkudata(L, 1, "Model");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_Model_get_bindPoseAt(lua_State *L) {
  Model* obj = luaL_checkudata(L, 1, "Model");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static const luaL_Reg l_Model[] = {
  {"getTransform", l_Model_get_transform},
  {"setTransform", l_Model_set_transform},
  {"getTransformU", l_Model_get_transformU},
  {"setTransformU", l_Model_set_transformU},
  {"getMeshCount", l_Model_get_meshCount},
  {"setMeshCount", l_Model_set_meshCount},
  {"getMeshAt", l_Model_get_meshAt},
  {"setMeshAt", l_Model_set_meshAt},
  {"getMaterialCount", l_Model_get_materialCount},
  {"setMaterialCount", l_Model_set_materialCount},
  {"getMaterialAt", l_Model_get_materialAt},
  {"setMaterialAt", l_Model_set_materialAt},
  {"getMeshMaterialAt", l_Model_get_meshMaterialAt},
  {"setMeshMaterialAt", l_Model_set_meshMaterialAt},
  {"getBoneCount", l_Model_get_boneCount},
  {"setBoneCount", l_Model_set_boneCount},
  {"getBonAt", l_Model_get_bonAt},
  {"setBonAt", l_Model_set_bonAt},
  {"getBindPoseAt", l_Model_get_bindPoseAt},
  {"setBindPoseAt", l_Model_set_bindPoseAt},
  {NULL, NULL}
};

static void l_Model_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "Model");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_Model, 0);
  lua_pop(L, 1);
}

static int l_Shader_set_id(lua_State *L) {
...
static int l_Shader_set_locAt(lua_State *L) {
  Shader* obj = luaL_checkudata(L, 1, "Shader");
  int idx = luaL_checkinteger(L, 2);
...
static int l_Shader_get_locAt(lua_State *L) {
  Shader* obj = luaL_checkudata(L, 1, "Shader");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0 || idx >= MAX_SHADER_LOCATIONS) return luaL_error(L, "Index out of bounds %d", idx, MAX_SHADER_LOCATIONS);
...
static const luaL_Reg l_Shader[] = {
  {"getId", l_Shader_get_id},
  {"setId", l_Shader_set_id},
  {"getLocAt", l_Shader_get_locAt},
  {"setLocAt", l_Shader_set_locAt},
  {NULL, NULL}
};

static void l_Shader_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "Shader");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_Shader, 0);
  lua_pop(L, 1);
}

static int l_ModelAnimation_set_boneCount(lua_State *L) {
...
static int l_ModelAnimation_get_boneCount(lua_State *L) {
  ModelAnimation* obj = luaL_checkudata(L, 1, "ModelAnimation");
  int result = obj->boneCount;
  lua_pushinteger(L, result);
  return 1;
...
static int l_ModelAnimation_set_bonAt(lua_State *L) {
  ModelAnimation* obj = luaL_checkudata(L, 1, "ModelAnimation");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0 || idx >= obj->boneCount) return luaL_error(L, "Index out of bounds %d", idx);
  BoneInfo bonesv = (*(BoneInfo*)luaL_checkudata(L, 3, "BoneInfo"));
...
static int l_ModelAnimation_get_bonAt(lua_State *L) {
  ModelAnimation* obj = luaL_checkudata(L, 1, "ModelAnimation");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0 || idx >= obj->boneCount) return luaL_error(L, "Index out of bounds %d", idx);
  BoneInfo result = obj->bones[idx];
...
static int l_ModelAnimation_set_frameCount(lua_State *L) {
  ModelAnimation* obj = luaL_checkudata(L, 1, "ModelAnimation");
...
static int l_ModelAnimation_get_frameCount(lua_State *L) {
  ModelAnimation* obj = luaL_checkudata(L, 1, "ModelAnimation");
...
static int l_ModelAnimation_set_framePosAt(lua_State *L) {
  ModelAnimation* obj = luaL_checkudata(L, 1, "ModelAnimation");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static int l_ModelAnimation_get_framePosAt(lua_State *L) {
  ModelAnimation* obj = luaL_checkudata(L, 1, "ModelAnimation");
  int idx = luaL_checkinteger(L, 2);
  if (idx < 0) return luaL_error(L, "Index out of bounds %d", idx);
...
static const luaL_Reg l_ModelAnimation[] = {
  {"getBoneCount", l_ModelAnimation_get_boneCount},
  {"setBoneCount", l_ModelAnimation_set_boneCount},
  {"getBonAt", l_ModelAnimation_get_bonAt},
  {"setBonAt", l_ModelAnimation_set_bonAt},
  {"getFrameCount", l_ModelAnimation_get_frameCount},
  {"setFrameCount", l_ModelAnimation_set_frameCount},
  {"getFramePosAt", l_ModelAnimation_get_framePosAt},
  {"setFramePosAt", l_ModelAnimation_set_framePosAt},
  {NULL, NULL}
};

static void l_ModelAnimation_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "ModelAnimation");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_ModelAnimation, 0);
  lua_pop(L, 1);
}

static int l_Matrix__eq(lua_State *L) {
  lua_getmetatable(L, 1); lua_getmetatable(L, 2);
  if (lua_rawequal(L, -1, -2) == 0) {
    lua_pushboolean(L, 0);
  } else {
...
static int l_Matrix_unpack(lua_State *L) {
...
static int l_Matrix_set_m0(lua_State *L) {
...
static int l_Matrix_get_m0(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
  float result = obj->m0;
  lua_pushnumber(L, result);
  return 1;
...
static int l_Matrix_set_m4(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static int l_Matrix_get_m4(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
  float result = obj->m4;
  lua_pushnumber(L, result);
  return 1;
...
static int l_Matrix_set_m8(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static int l_Matrix_get_m8(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
  float result = obj->m8;
  lua_pushnumber(L, result);
  return 1;
...
static int l_Matrix_set_m12(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static int l_Matrix_get_m12(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static int l_Matrix_set_m1(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static int l_Matrix_get_m1(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
  float result = obj->m1;
  lua_pushnumber(L, result);
  return 1;
...
static int l_Matrix_set_m5(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static int l_Matrix_get_m5(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
  float result = obj->m5;
  lua_pushnumber(L, result);
  return 1;
...
static int l_Matrix_set_m9(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static int l_Matrix_get_m9(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
  float result = obj->m9;
  lua_pushnumber(L, result);
  return 1;
...
static int l_Matrix_set_m13(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static int l_Matrix_get_m13(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static int l_Matrix_set_m2(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static int l_Matrix_get_m2(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
  float result = obj->m2;
  lua_pushnumber(L, result);
  return 1;
...
static int l_Matrix_set_m6(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static int l_Matrix_get_m6(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
  float result = obj->m6;
  lua_pushnumber(L, result);
  return 1;
...
static int l_Matrix_set_m10(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static int l_Matrix_get_m10(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static int l_Matrix_set_m14(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static int l_Matrix_get_m14(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static int l_Matrix_set_m3(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static int l_Matrix_get_m3(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
  float result = obj->m3;
  lua_pushnumber(L, result);
  return 1;
...
static int l_Matrix_set_m7(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static int l_Matrix_get_m7(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
  float result = obj->m7;
  lua_pushnumber(L, result);
  return 1;
...
static int l_Matrix_set_m11(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static int l_Matrix_get_m11(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static int l_Matrix_set_m15(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static int l_Matrix_get_m15(lua_State *L) {
  Matrix* obj = luaL_checkudata(L, 1, "Matrix");
...
static const luaL_Reg l_Matrix[] = {
  {"getM0", l_Matrix_get_m0},
  {"setM0", l_Matrix_set_m0},
  {"getM4", l_Matrix_get_m4},
  {"setM4", l_Matrix_set_m4},
  {"getM8", l_Matrix_get_m8},
  {"setM8", l_Matrix_set_m8},
  {"getM12", l_Matrix_get_m12},
  {"setM12", l_Matrix_set_m12},
  {"getM1", l_Matrix_get_m1},
  {"setM1", l_Matrix_set_m1},
  {"getM5", l_Matrix_get_m5},
  {"setM5", l_Matrix_set_m5},
  {"getM9", l_Matrix_get_m9},
  {"setM9", l_Matrix_set_m9},
  {"getM13", l_Matrix_get_m13},
  {"setM13", l_Matrix_set_m13},
  {"getM2", l_Matrix_get_m2},
  {"setM2", l_Matrix_set_m2},
  {"getM6", l_Matrix_get_m6},
  {"setM6", l_Matrix_set_m6},
  {"getM10", l_Matrix_get_m10},
  {"setM10", l_Matrix_set_m10},
  {"getM14", l_Matrix_get_m14},
  {"setM14", l_Matrix_set_m14},
  {"getM3", l_Matrix_get_m3},
  {"setM3", l_Matrix_set_m3},
  {"getM7", l_Matrix_get_m7},
  {"setM7", l_Matrix_set_m7},
  {"getM11", l_Matrix_get_m11},
  {"setM11", l_Matrix_set_m11},
  {"getM15", l_Matrix_get_m15},
  {"setM15", l_Matrix_set_m15},
  {"__eq", l_Matrix__eq},
  {"unpack", l_Matrix_unpack},
  {NULL, NULL}
};

static void l_Matrix_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "Matrix");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_Matrix, 0);
  lua_pop(L, 1);
}
...
static int l_Color_unpack(lua_State *L) {
...
static int l_Color_set_r(lua_State *L) {
...
static int l_Color_get_r(lua_State *L) {
  Color* obj = luaL_checkudata(L, 1, "Color");
...
static int l_Color_set_g(lua_State *L) {
  Color* obj = luaL_checkudata(L, 1, "Color");
...
static int l_Color_get_g(lua_State *L) {
  Color* obj = luaL_checkudata(L, 1, "Color");
...
static int l_Color_set_b(lua_State *L) {
  Color* obj = luaL_checkudata(L, 1, "Color");
...
static int l_Color_get_b(lua_State *L) {
  Color* obj = luaL_checkudata(L, 1, "Color");
...
static int l_Color_set_a(lua_State *L) {
  Color* obj = luaL_checkudata(L, 1, "Color");
...
static int l_Color_get_a(lua_State *L) {
  Color* obj = luaL_checkudata(L, 1, "Color");
...
static const luaL_Reg l_Color[] = {
  ...
  {"setA", l_Color_set_a},
  {"__eq", l_Color__eq},
  {"unpack", l_Color_unpack},
  {NULL, NULL}
};

static void l_Color_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "Color");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_Color, 0);
  lua_pop(L, 1);
}
...
static int l_Transform_get_translation(lua_State *L) {
  Transform* obj = luaL_checkudata(L, 1, "Transform");
...
static int l_Transform_set_translationU(lua_State *L) {
  Transform* obj = luaL_checkudata(L, 1, "Transform");
...
static int l_Transform_get_translationU(lua_State *L) {
  Transform* obj = luaL_checkudata(L, 1, "Transform");
  Vector3 result = obj->translation;
  lua_pushnumber(L, result.x);lua_pushnumber(L, result.y);lua_pushnumber(L, result.z);
  return 3;
...
static int l_Transform_get_rotation(lua_State *L) {
  Transform* obj = luaL_checkudata(L, 1, "Transform");
...
static int l_Transform_set_rotationU(lua_State *L) {
  Transform* obj = luaL_checkudata(L, 1, "Transform");
...
static int l_Transform_get_rotationU(lua_State *L) {
  Transform* obj = luaL_checkudata(L, 1, "Transform");
  Vector4 result = obj->rotation;
  lua_pushnumber(L, result.x);lua_pushnumber(L, result.y);lua_pushnumber(L, result.z);lua_pushnumber(L, result.w);
  return 4;
...
static int l_Transform_set_scale(lua_State *L) {
  Transform* obj = luaL_checkudata(L, 1, "Transform");
...
static int l_Transform_get_scale(lua_State *L) {
  Transform* obj = luaL_checkudata(L, 1, "Transform");
...
static int l_Transform_set_scaleU(lua_State *L) {
  Transform* obj = luaL_checkudata(L, 1, "Transform");
...
static int l_Transform_get_scaleU(lua_State *L) {
  Transform* obj = luaL_checkudata(L, 1, "Transform");
  Vector3 result = obj->scale;
  lua_pushnumber(L, result.x);lua_pushnumber(L, result.y);lua_pushnumber(L, result.z);
  return 3;
...
static const luaL_Reg l_Transform[] = {
  {"getTranslation", l_Transform_get_translation},
  {"setTranslation", l_Transform_set_translation},
  {"getTranslationU", l_Transform_get_translationU},
  {"setTranslationU", l_Transform_set_translationU},
  {"getRotation", l_Transform_get_rotation},
  {"setRotation", l_Transform_set_rotation},
  {"getRotationU", l_Transform_get_rotationU},
  {"setRotationU", l_Transform_set_rotationU},
  {"getScale", l_Transform_get_scale},
  {"setScale", l_Transform_set_scale},
  {"getScaleU", l_Transform_get_scaleU},
  {"setScaleU", l_Transform_set_scaleU},
  {NULL, NULL}
};

static void l_Transform_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "Transform");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_Transform, 0);
  lua_pop(L, 1);
}

static int l_Ray_set_position(lua_State *L) {
...
static int l_Ray_get_position(lua_State *L) {
  Ray* obj = luaL_checkudata(L, 1, "Ray");
  Vector3 result = obj->position;
  Vector3* userdata = lua_newuserdata(L, sizeof *userdata); *userdata = result; luaL_setmetatable(L, "Vector3");
  return 1;
...
static int l_Ray_set_positionU(lua_State *L) {
  Ray* obj = luaL_checkudata(L, 1, "Ray");
  Vector3 position = {luaL_checknumber(L, 2), luaL_checknumber(L, 3), luaL_checknumber(L, 4)};
  obj->position = position;
  lua_pop(L, 3);
...
static int l_Ray_get_positionU(lua_State *L) {
  Ray* obj = luaL_checkudata(L, 1, "Ray");
  Vector3 result = obj->position;
  lua_pushnumber(L, result.x);lua_pushnumber(L, result.y);lua_pushnumber(L, result.z);
  return 3;
...
static int l_Ray_set_direction(lua_State *L) {
  Ray* obj = luaL_checkudata(L, 1, "Ray");
...
static int l_Ray_get_direction(lua_State *L) {
  Ray* obj = luaL_checkudata(L, 1, "Ray");
...
static int l_Ray_set_directionU(lua_State *L) {
  Ray* obj = luaL_checkudata(L, 1, "Ray");
...
static int l_Ray_get_directionU(lua_State *L) {
  Ray* obj = luaL_checkudata(L, 1, "Ray");
  Vector3 result = obj->direction;
  lua_pushnumber(L, result.x);lua_pushnumber(L, result.y);lua_pushnumber(L, result.z);
  return 3;
...
static const luaL_Reg l_Ray[] = {
  {"getPosition", l_Ray_get_position},
  {"setPosition", l_Ray_set_position},
  {"getPositionU", l_Ray_get_positionU},
  {"setPositionU", l_Ray_set_positionU},
  {"getDirection", l_Ray_get_direction},
  {"setDirection", l_Ray_set_direction},
  {"getDirectionU", l_Ray_get_directionU},
  {"setDirectionU", l_Ray_set_directionU},
  {NULL, NULL}
};

static void l_Ray_register(lua_State *L, const char *ref) {
  luaL_newmetatable(L, ref ? ref : "Ray");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  luaL_setfuncs(L, l_Ray, 0);
  lua_pop(L, 1);
}
...
LUAMOD_API int luaopen_raylib(lua_State *L) {
  ...
  l_CharInfo_register(L, NULL);
  l_IVector2_register(L, NULL);
  l_IVector4_register(L, NULL);
  l_VrDeviceInfo_register(L, NULL);
  l_NPatchInfo_register(L, NULL);
  l_Material_register(L, NULL);
  l_Vector2_register(L, NULL);
  l_Rectangle_register(L, NULL);
  l_BoundingBox_register(L, NULL);
  l_Camera2D_register(L, NULL);
  l_Vector3_register(L, NULL);
  l_Camera3D_register(L, NULL);
  l_Mesh_register(L, NULL);
  l_AudioStream_register(L, NULL);
  l_Texture2D_register(L, NULL);
  l_Font_register(L, NULL);
  l_Sound_register(L, NULL);
  l_BoneInfo_register(L, NULL);
  l_MaterialMap_register(L, NULL);
  l_RenderTexture2D_register(L, NULL);
  l_RayHitInfo_register(L, NULL);
  l_Vector4_register(L, NULL);
  l_Model_register(L, NULL);
  l_Shader_register(L, NULL);
  l_ModelAnimation_register(L, NULL);
  l_Matrix_register(L, NULL);
  l_Color_register(L, NULL);
  l_Transform_register(L, NULL);
  l_Ray_register(L, NULL);
  lua_pushnumber(L, PI);
  lua_setfield(L, -2, "PI");
